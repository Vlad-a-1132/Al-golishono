...
export const metadata = {
  title: 'Блог - Медицинские статьи и новости | Медицинский центр Альтамед Голицыно',
  description: 'Блог медицинского центра Альтамед Голицыно - медицинские статьи, новости о здоровье, советы врачей, полезная информация о профилактике заболеваний и здоровом образе жизни.',
  keywords: [
    'медицинские статьи Голицыно',
    'новости о здоровье Голицыно',
    'советы врачей Голицыно',
    'медицинский блог Голицыно',
    'статьи о здоровье Голицыно',
    'профилактика заболеваний Голицыно',
    'здоровый образ жизни Голицыно',
    'блог Альтамед Голицыно',
    'Московская область медицинские статьи',
    'Голицыно новости о здоровье'
  ],
  openGraph: {
    title: 'Блог - Медицинские статьи и новости | Медицинский центр Альтамед Голицыно',
    description: 'Блог медицинского центра Альтамед Голицыно - медицинские статьи, новости о здоровье, советы врачей, полезная информация.',
