...
export const metadata = {
  title: 'Блог - Медицинские статьи и новости | Медицинский центр Альтамед Голицино',
  description: 'Блог медицинского центра Альтамед Голицино - медицинские статьи, новости о здоровье, советы врачей, полезная информация о профилактике заболеваний и здоровом образе жизни.',
  keywords: [
    'медицинские статьи Голицино',
    'новости о здоровье Голицино',
    'советы врачей Голицино',
    'медицинский блог Голицино',
    'статьи о здоровье Голицино',
    'профилактика заболеваний Голицино',
    'здоровый образ жизни Голицино',
    'блог Альтамед Голицино',
    'Московская область медицинские статьи',
    'Голицино новости о здоровье'
  ],
  openGraph: {
    title: 'Блог - Медицинские статьи и новости | Медицинский центр Альтамед Голицино',
    description: 'Блог медицинского центра Альтамед Голицино - медицинские статьи, новости о здоровье, советы врачей, полезная информация.',
