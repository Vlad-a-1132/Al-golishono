    ...
    <div className="flex flex-col bg-white">
      <section className="pt-4 md:pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-black">
            УЗИ сердца (эхокардиография) в Голицино — исследование в медицинском центре Альтамед Голицино
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <div className="w-full md:w-1/2">
              <div className="relative w-full aspect-square max-w-md mx-auto rounded-full overflow-hidden">
                <Image
                  ...
                  alt="УЗИ сердца в Альтамед Голицино"
                  fill
            ...
            <div className="w-full md:w-1/2 text-gray-700 space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-black">Эхокардиография в Голицино</h2>
              <p>
                УЗИ сердца (эхокардиография) — ультразвуковое исследование сердца, позволяющее оценить его структуру, размеры камер, состояние клапанов, сократительную способность миокарда и кровоток. В медицинском центре Альтамед Голицино исследование проводится на современном оборудовании экспертного класса.
              </p>
              <p>
                Эхокардиография безопасна, неинвазивна и не несёт лучевой нагрузки. Результаты выдаются в день исследования. Врачи медицинского центра Альтамед Голицино проводят исследование на современных ультразвуковых сканерах с режимом допплерографии, что позволяет оценить не только анатомию сердца, но и кровоток через клапаны и крупные сосуды.
              </p>
              <p>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            В медицинском центре Альтамед Голицино используется режим допплерографии — он позволяет оценить направление и скорость кровотока. Это необходимо для диагностики пороков сердца, оценки степени регургитации (обратного заброса крови через клапаны), выявления сужений и аневризм. Эхокардиография не имеет лучевой нагрузки и может проводиться многократно, в том числе у детей и беременных.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Когда стоит обратиться на УЗИ сердца в Голицино</h2>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Как проходит УЗИ сердца в Альтамед Голицино</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Что оценивает врач при УЗИ сердца в Голицино</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            В ходе эхокардиографии в медицинском центре Альтамед Голицино врач функциональной диагностики оценивает следующие параметры:
          </p>
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            На основе этих данных формулируется заключение и при необходимости даются рекомендации по дальнейшему обследованию или лечению. УЗИ сердца в Альтамед Голицино позволяет выявить ишемическую болезнь сердца, пороки, кардиомиопатии, последствия инфаркта и другие патологии.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Преимущества УЗИ сердца в Альтамед Голицино</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
