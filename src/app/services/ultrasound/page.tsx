...
export default function UltrasoundPage() {
  ...
  const faqItems = [
    {
      question: "Как подготовиться к УЗИ в Одинцово?",
      answer: "Подготовка зависит от типа исследования. Для УЗИ брюшной полости в клинике «Альтамед-С» требуется голод 6-8 часов и за 3 дня исключить продукты, вызывающие газообразование. Для УЗИ органов малого таза нужен наполненный мочевой пузырь. Для УЗИ щитовидной железы и УЗИ суставов подготовка не требуется. Подробную инструкцию по подготовке к конкретному УЗИ вы получите при записи в Одинцово."
    },
    {
      question: "Сколько длится процедура УЗИ в Одинцово?",
    ...
    {
      question: "Безопасно ли УЗИ при беременности в Одинцово?",
  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              УЗИ в клинике «<span className="italic">Альтамед-с</span>» в Одинцово
            </h1>
            <p className="text-gray-600 mt-2 px-4 md:px-0 text-sm md:text-base">
              Современная ультразвуковая диагностика на оборудовании экспертного класса в Одинцово
            </p>
          </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Полный спектр УЗИ-исследований в клинике «Альтамед-С» в Одинцово
            </p>
          </div>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">УЗИ в Одинцово: современная безопасная диагностика</h2>
          <div className="mb-8">
            <p className="text-gray-700 mb-4 leading-relaxed">
              <strong>Ультразвуковое исследование (УЗИ)</strong> — это безопасный, безболезненный и высокоинформативный метод диагностики, использующий ультразвуковые волны для визуализации внутренних органов и тканей. В медицинском центре «Альтамед-С» в Одинцово УЗИ выполняется на современном оборудовании экспертного класса, что обеспечивает высочайшую точность диагностики и качественные изображения.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Основные преимущества УЗИ в Одинцово — полная безопасность (нет ионизирующего излучения), безболезненность процедуры, немедленное получение результатов, возможность многократного исследования, высокая информативность. В клинике «Альтамед-С» проводятся все виды ультразвуковой диагностики: УЗИ органов брюшной полости, УЗИ малого таза, УЗИ сосудов шеи и конечностей, УЗИ сердца (эхокардиография), УЗИ щитовидной железы, УЗИ молочных желез, УЗИ при беременности, УЗИ детям.
            </p>
            <div className="bg-gray-50 rounded-[20px] p-6 shadow-md border-l-4 border-[#2C83A7]">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Преимущества УЗИ в клинике «Альтамед-С» в Одинцово:</h3>
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start">
                  ...
                  <span>Удобное расположение в центре Одинцово</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Показания к УЗИ в Одинцово</h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Популярные УЗИ-исследования в Одинцово</h2>
          <p className="text-gray-700 mb-6 text-center max-w-3xl mx-auto">
            В медицинском центре «Альтамед-С» в Одинцово наиболее часто выполняются следующие виды ультразвуковой диагностики:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-blue-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">УЗИ сосудов шеи в Одинцово</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-blue-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">УЗИ вен нижних конечностей в Одинцово</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-blue-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">УЗИ малого таза в Одинцово</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-blue-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">УЗИ сердца (эхокардиография) в Одинцово</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-blue-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">УЗИ брюшной полости в Одинцово</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-blue-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">УЗИ молочных желез в Одинцово</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">УЗИ детям в Одинцово</h2>
          <div className="bg-white rounded-[20px] p-8 shadow-lg border-l-4 border-[#2C83A7]">
            <p className="text-gray-700 mb-4 leading-relaxed">
              В медицинском центре «Альтамед-С» в Одинцово УЗИ детям проводится с особой заботой и вниманием. Ультразвуковая диагностика абсолютно безопасна для детей любого возраста, включая новорожденных, и может проводиться многократно без вреда для здоровья.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <p className="text-gray-700 leading-relaxed">
              Врачи клиники «Альтамед-С» имеют большой опыт работы с детьми, создают комфортную и спокойную атмосферу, используют специальные протоколы исследования. УЗИ детям в Одинцово — это безопасный, быстрый и информативный метод диагностики.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Подготовка к УЗИ в Одинцово</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Часто задаваемые вопросы об УЗИ в Одинцово</h2>
