...
export default function UltrasoundPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Стоимость УЗИ в клинике «Альтамед Голицыно» зависит от типа исследования. Цены начинаются от 900 рублей за УЗИ отдельных органов (печень, желчный пузырь, селезенка). УЗИ комплексов органов обходится дороже. Например, УЗИ органов малого таза стоит от 1900 рублей, УЗИ сосудов — от 3300 рублей, эхокардиография — 4700 рублей. Уточнить точную стоимость конкретного УЗИ вы можете при записи или по телефону клиники в Голицыно."
    },
    {
  ...
  return (
    <div className="flex flex-col bg-white">
      <section className="pt-4 md:pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-black">
            Ультразвуковое обследование (УЗИ) в Голицыно — исследование в медицинском центре Альтамед Голицыно
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="w-full md:w-1/2 text-gray-700 space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-black">УЗИ в Голицыно</h2>
              <p>
                Ультразвуковое исследование (сонография) — один из наиболее современных, информативных и доступных методов инструментальной диагностики. В медицинском центре Альтамед Голицыно УЗИ проводится на современном оборудовании экспертного класса. Несомненным преимуществом УЗИ является неинвазивность и отсутствие лучевой нагрузки.
              </p>
              <p>
              ...
              <p>
                В медицинском центре Альтамед Голицыно УЗИ проводится на современном оборудовании экспертного класса. Врачи-диагносты имеют большой опыт работы и проводят исследования по стандартизированным протоколам. Записаться на УЗИ можно через форму на сайте или по телефону клиники.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Противопоказания и ограничения к УЗИ в Голицыно</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Ультразвуковое исследование не имеет абсолютных противопоказаний. Метод безопасен для детей любого возраста, беременных и пожилых людей; его можно проводить многократно без вреда для здоровья. В отличие от рентгенографии, при УЗИ не используется ионизирующее излучение.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Ограничения могут быть связаны с типом исследования: например, при УЗИ органов брюшной полости информативность снижается при выраженном метеоризме (газ в кишечнике плохо пропускает ультразвук), поэтому важна подготовка — диета и голод перед исследованием. При УЗИ органов малого таза трансабдоминальным доступом нужен наполненный мочевой пузырь; при трансвагинальном или трансректальном доступе подготовка не требуется. В медицинском центре Альтамед Голицыно врачи подберут оптимальный вид исследования и дадут рекомендации по подготовке.
          </p>
        </div>
      </section>
