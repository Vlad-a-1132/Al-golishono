...
export default function PhysiotherapyPage() {
  const prices: Array<{ name: string; price: number }> = [
    { name: "Осмотр (консультация) врача-физиотерапевта", price: 2500 },
    { name: "Интерференцтерапия при заболеваниях кожи и подкожно-жировой клетчатки", price: 1200 },
    { name: "Миоэлектростимуляция", price: 1200 },
    { name: "Воздействие магнитными полями при костной патологии", price: 1200 },
    { name: "Электрофорез лекарственных препаратов при патологии полости рта и зубов", price: 1300 },
    { name: "Магнитотерапия при патологии полости рта и зубов", price: 1200 },
    { name: "Дарсонвализация при патологии полости рта", price: 1200 },
    { name: "Воздействие магнитными полями при патологии полости рта и зубов", price: 1200 },
    { name: "Электрофорез лекарственных препаратов при заболеваниях верхних дыхательных путей", price: 1300 },
    { name: "Электрофорез лекарственных препаратов эндоназальный", price: 1300 },
    { name: "Дарсонвализация при заболеваниях верхних дыхательных путей", price: 1200 },
    { name: "Аэрозольтерапия при заболеваниях верхних дыхательных путей", price: 1200 },
    { name: "Электрофорез лекарственных препаратов при патологии легких", price: 1300 },
    { name: "Электроаэрозольвоздействие при заболеваниях нижних дыхательных путей", price: 1200 },
    { name: "Аэрозольтерапия при заболеваниях нижних дыхательных путей", price: 1200 },
    { name: "Воздействие с помощью галакамеры при заболеваниях нижних дыхательных путей", price: 1200 },
    { name: "Дарсонвализация местная при заболеваниях крупных кровеносных сосудов", price: 1200 },
    { name: "Электрофорез лекарственных препаратов при нарушениях микроциркуляции", price: 1300 },
    { name: "Электрофорез лекарственных препаратов при заболеваниях желудка и двенадцатиперстной кишки", price: 1300 },
    { name: "Переменное магнитное поле при заболеваниях женских половых органов", price: 1200 },
    { name: "Электрофорез лекарственных препаратов при заболеваниях женских половых органов", price: 1300 },
    { name: "Электрофорез лекарственных препаратов при заболеваниях мужских половых органов", price: 1300 },
    { name: "Электрофорез лекарственных препаратов при заболеваниях желез внутренней секреции", price: 1300 },
    { name: "Чрескожная электронейростимуляция при заболеваниях периферической нервной системы", price: 1200 },
    { name: "Гальванотерапия при заболеваниях периферической нервной системы", price: 1200 },
    { name: "Токи Бернара при заболеваниях периферической нервной системы", price: 1200 },
    { name: "Электрофорез лекарственных препаратов при заболеваниях периферической нервной системы", price: 1300 },
    { name: "Воздействие синусоидальными модулированными токами (СМТ-терапия) при заболеваниях периферической нервной системы", price: 1200 },
    { name: "Воздействие магнитными полями при заболеваниях периферической нервной системы", price: 1200 },
    { name: "Воздействие высокочастотными электромагнитными полями (на аппарате ТЕКАР)", price: 1800 },
    { name: "Многофункциональная электростимуляция скелетных мышц", price: 1200 },
    { name: "Электростимуляция периферических двигательных нервов и скелетных мышц", price: 1200 },
    { name: "Внутриушной электрофорез лекарственных препаратов при заболеваниях органа слуха", price: 1300 },
    { name: "Дарсонвализация органа слуха", price: 1200 },
    { name: "Электрофорез лекарственных препаратов при заболеваниях органа зрения", price: 1300 },
    { name: "Низкочастотная магнитотерапия на орган зрения", price: 1000 },
    { name: "Гальванотерапия при заболеваниях органа зрения", price: 1200 },
    { name: "Электростимуляция мочеточников при заболеваниях почек и мочевыделительного тракта", price: 1200 },
    { name: "Электростимуляция мочевого пузыря", price: 1200 },
    { name: "Введение лекарственных препаратов методом электрофореза при неуточненных заболеваниях", price: 1300 },
    { name: "Диадинамотерапия (ДДТ)", price: 1200 },
    { name: "Воздействие синусоидальными модулированными токами (СМТ)", price: 1200 },
    { name: "Воздействие интерференционными токами", price: 1200 },
    { name: "Баровоздействие - прессотерапия конечностей, пневмокомпрессия", price: 1500 },
    { name: "Воздействие электрическим полем ультравысокой частоты (ЭП УВЧ)", price: 1300 },
    { name: "Воздействие переменным магнитным полем (ПеМП)", price: 1200 },
    { name: "Воздействие магнитными полями при заболеваниях мышц", price: 1200 },
    { name: "Электрофорез импульсными токами", price: 1300 },
    { name: "Электрофорез диадинамическими токами (ДDТ-форез)", price: 1300 },
    { name: "Электрофорез синусоидальными модулированными токами (СМТ-форез)", price: 1300 },
    { name: "Общая магнитотерапия", price: 1200 },
    { name: "Лазерофорез", price: 1200 },
    { name: "Аэрозольтерапия", price: 1200 },
    { name: "Электростимуляция лицевого и/или тройничного нерва, мимических и/или жевательных мышц", price: 1200 },
    { name: "Воздействие магнитными полями Высокоинтенсивная магнитотерапия (SIS)", price: 1800 },
    { name: "Ультрафонофорез лекарственный", price: 1300 },
    { name: "Воздействие переменным электростатическим полем (на аппарате ЭЛГОС)", price: 1200 },
    { name: "Магнитофорез", price: 1300 },
    { name: "Ультразвуковое лечение кожи", price: 1200 },
    { name: "Ультрафонофорез лекарственный кожи", price: 1300 },
    { name: "Воздействие низкоинтенсивным лазерным излучением при заболеваниях мышц", price: 1200 },
    { name: "Ультрафонофорез лекарственный при заболеваниях мышц", price: 1300 },
    { name: "Воздействие ультразвуком при заболеваниях суставов", price: 1200 },
    { name: "Ультрафонофорез лекарственный при заболеваниях суставов", price: 1300 },
    { name: "Воздействие низкоинтенсивным лазерным излучением при заболеваниях суставов", price: 1200 },
    { name: "Ультрафиолетовое облучение при заболеваниях суставов", price: 1000 },
    { name: "Лазерная физиотерапия челюстно-лицевой области", price: 1200 },
    { name: "Ультрафиолетовое облучение ротоглотки", price: 1000 },
    { name: "Воздействие лазерным низкоинтенсивным излучением на область десен", price: 1200 },
    { name: "Воздействие ультразвуком при заболеваниях верхних дыхательных путей", price: 1200 },
    { name: "Воздействие лазерным низкоинтенсивным излучением на область зева", price: 1200 },
    { name: "Воздействие лазерным низкоинтенсивным излучением эндоназально", price: 1200 },
    { name: "Ультрафонофорез лекарственный при заболеваниях верхних дыхательных путей", price: 1300 },
    { name: "Воздействие коротким ультрафиолетовым светом при заболеваниях верхних дыхательных путей", price: 1000 },
    { name: "Воздействие низкоинтенсивным лазерным излучением при заболеваниях верхних дыхательных путей", price: 1200 },
    { name: "Лазеротерапия при заболеваниях женских половых органов", price: 1300 },
    { name: "Воздействие низкоиненсивным лазерным излучением вагинально", price: 1300 },
    { name: "Воздействие низкоинтенсивным лазерным излучением при заболеваниях периферической нервной системы", price: 1300 },
    { name: "Воздействие ультразвуковое при заболеваниях периферической нервной системы", price: 1300 },
    { name: "Лекарственный ультрафонофорез при заболеваниях периферической нервной системы", price: 1300 },
    { name: "Светолечение коротким ультрафиолетовым излучением наружного уха", price: 1000 },
    { name: "Ультрафиолетовое облучение (местное) при заболеваниях глаза и его придаточных пазух", price: 1000 },
    { name: "Воздействие ультразвуковое при заболеваниях органов зрения", price: 1000 },
    { name: "Ультрафонофорез препаратов при заболеваниях органов зрения", price: 1300 },
    { name: "Воздействие ультразвуковое при заболеваниях почек и мочевыделительного тракта", price: 1300 },
    { name: "Воздействие коротким ультрафиолетовым излучением (КУФ)", price: 1000 },
    { name: "Воздействие поляризованным светом", price: 1200 },
    { name: "Высокоинтенсивная лазеротерапия (1зона)", price: 3000 },
    { name: "Высокоинтенсивная лазеротерапия (2 зоны) High Intensity Laser Therapy (HILT)", price: 4800 },
  ];
