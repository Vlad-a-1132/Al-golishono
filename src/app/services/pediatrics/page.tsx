  ...
  const pediatricsServices = [
    {
      ...
      services: [
        { name: 'Прием (осмотр, консультация) врача-педиатра первичный', price: '3100' },
        { name: 'Прием (осмотр, консультация) врача-педиатра повторный', price: '2700' },
        { name: 'Диспансерный прием (осмотр, консультация) врача-педиатра', price: '2300' },
        { name: 'Профилактический прием (осмотр, консультация) врача-педиатра', price: '1000' },
      ]
    },
    {
      category: 'Вакцинация',
      services: [
        { name: 'Вакцинация', price: '500' },
      ]
    }
  ];
