...
export const metadata: Metadata = {
  ...
  description: 'Дерматолог в Одинцово - профессиональная диагностика и лечение кожных заболеваний. Дерматоскопия, удаление новообразований, лечение акне. Запись на прием к дерматологу в клинике Альтамед-с Одинцово.',
  keywords: [
    'дерматолог Одинцово',
