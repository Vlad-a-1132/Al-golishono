    ...
    <div className="flex flex-col min-h-full bg-white mx-auto">
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              Рентгенография и диагностические исследования в Альтамед Голицино — «<span className="italic">Альтамед Голицино</span>»
            </h1>
            <p className="text-gray-600 mt-2 px-4 md:px-0 text-sm md:text-base">
              Современная рентген-диагностика в стоматологии Альтамед Голицино. Точная диагностика заболеваний зубов и челюстей с помощью передового оборудования.
            </p>
          </header>
          ...
          <div className="mb-8">
            <div className="block md:hidden w-full h-[300px] flex flex-col rounded-[20px] overflow-hidden shadow-md mx-auto">
              ...
              <div className="bg-white p-4 flex flex-col justify-between items-start gap-3">
                <div className="text-black font-medium text-sm">Рентген-диагностика в Альтамед Голицино</div>
            ...
            <div className="hidden md:block h-[445px] relative overflow-hidden rounded-[20px] shadow-lg">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-start p-8 md:p-12 text-black z-10">
                <h2 className="text-2xl md:text-4xl font-bold mb-4">Рентгенография и диагностика в Альтамед Голицино</h2>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 text-center">
              Виды рентген-диагностики в стоматологии Альтамед Голицино
            </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
            Прайс-лист рентген-диагностики в Альтамед Голицино
          </h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Почему важна рентген-диагностика в стоматологии Альтамед Голицино
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  title: "Точная диагностика скрытых проблем",
                  text: "Рентген-снимки позволяют выявить проблемы, которые невозможно увидеть при визуальном осмотре: кариес между зубами, состояние корней, кисты, абсцессы, ретинированные зубы. В клинике «Альтамед Голицино» Альтамед Голицино мы используем современное цифровое оборудование с минимальной лучевой нагрузкой.",
                  icon: "🔍"
                },
                {
                  title: "Контроль качества лечения",
                  text: "Рентгенография позволяет контролировать качество пломбирования корневых каналов, правильность установки имплантов, эффективность ортодонтического лечения. Регулярные снимки в стоматологии Альтамед Голицино помогают своевременно корректировать лечение.",
                  icon: "✅"
                },
                {
                  title: "Планирование сложных вмешательств",
                  text: "Перед имплантацией, хирургическими операциями, ортодонтическим лечением необходима точная диагностика. Рентген-снимки позволяют врачам стоматологии Альтамед Голицино составить детальный план лечения и предвидеть возможные осложнения.",
                  icon: "📋"
                },
                {
                  title: "Безопасность пациента",
                  text: "Современное цифровое рентген-оборудование в «Альтамед Голицино» Альтамед Голицино имеет минимальную лучевую нагрузку, что делает диагностику безопасной даже для детей и беременных женщин (при необходимости).",
                  icon: "🛡️"
                }
              ].map((item, idx) => (
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Современное оборудование для диагностики в Альтамед Голицино
            </h2>
            <div className="space-y-6">
              {[
                {
                  title: "Цифровые визиографы",
                  desc: "В клинике «Альтамед Голицино» Альтамед Голицино используются современные цифровые визиографы, которые позволяют получать снимки высокого качества при минимальной лучевой нагрузке. Результат доступен мгновенно.",
                ...
                },
                {
                  ...
                  desc: "Возможность создания трехмерных моделей челюстей на основе КТ-данных открывает новые возможности для планирования лечения в стоматологии Альтамед Голицино.",
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Когда необходима рентген-диагностика в Альтамед Голицино
            </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Стоимость рентген-диагностики в стоматологии Альтамед Голицино
            </h2>
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Цены на рентгенографию и диагностические исследования в клинике «Альтамед Голицино» Альтамед Голицино зависят от вида снимка и сложности процедуры. Мы используем современное цифровое оборудование, которое обеспечивает минимальную лучевую нагрузку и высокое качество изображений.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="bg-purple-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Панорамная рентгенография в Альтамед Голицино</h3>
                  <p className="text-gray-600 mb-3">
                    Панорамный снимок (ОПТГ) в стоматологии Альтамед Голицино позволяет получить полную картину состояния всех зубов и челюстей. Это незаменимая диагностическая процедура для планирования лечения.
                  </p>
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start">
                ...
                <div className="bg-pink-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Радиовизиография в Альтамед Голицино</h3>
                  <p className="text-gray-600 mb-3">
                    Прицельные снимки на визиографе в стоматологии Альтамед Голицино используются для детальной диагностики отдельных зубов. Процедура занимает считанные секунды и дает мгновенный результат.
                  </p>
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start">
              ...
              <p className="mt-6 text-gray-600">
                Точную стоимость рентген-диагностики в стоматологии Альтамед Голицино можно узнать после консультации. Мы предлагаем комплексные программы диагностики по доступным ценам. Запишитесь на прием в «Альтамед Голицино» Альтамед Голицино для получения детальной информации.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Когда необходима рентген-диагностика в стоматологии Альтамед Голицино
            </h2>
            ...
            <div className="mt-8 bg-white rounded-lg p-6 border-2 border-purple-200">
              <p className="text-gray-700 text-lg leading-relaxed">
                Рентген-диагностика в клинике «Альтамед Голицино» Альтамед Голицино является важнейшей частью современного стоматологического лечения. Современное цифровое оборудование обеспечивает минимальную лучевую нагрузку при максимальной информативности снимков. Опытные рентгенологи стоматологии Альтамед Голицино проводят все виды исследований с высокой точностью, что позволяет врачам составить оптимальный план лечения.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Безопасность рентген-диагностики в стоматологии Альтамед Голицино
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Минимальная лучевая нагрузка</h3>
                <p className="text-gray-700 mb-4">
                  Современное цифровое оборудование в клинике «Альтамед Голицино» Альтамед Голицино обеспечивает минимальную лучевую нагрузку. Цифровая радиовизиография дает дозу облучения в 10 раз меньше, чем традиционные пленочные снимки.
                </p>
              ...
              <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Цифровая рентген-диагностика в стоматологии Альтамед Голицино обеспечивает высокое разрешение и четкость изображений. Врачи могут увеличивать изображения, менять контрастность и делать точные измерения.
                </p>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-pink-600 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-8 bg-white rounded-lg p-6 border-2 border-purple-200">
              <p className="text-gray-700 text-lg leading-relaxed">
                В клинике «Альтамед Голицино» Альтамед Голицино мы строго соблюдаем все нормы радиационной безопасности. Все рентген-исследования проводятся по медицинским показаниям с использованием современного оборудования последнего поколения. Наши специалисты прошли специальное обучение и имеют соответствующие сертификаты для работы с рентген-аппаратурой. Рентген-диагностика в стоматологии Альтамед Голицино абсолютно безопасна при соблюдении рекомендаций врача.
              </p>
            </div>
          </div>
        </div>
              ...
              {[
                {
                  ...
                  a: "Современное цифровое рентген-оборудование имеет минимальную лучевую нагрузку, которая в десятки раз ниже, чем при традиционной пленочной рентгенографии. В клинике «Альтамед Голицино» Альтамед Голицино мы используем только современное оборудование, соответствующее всем стандартам безопасности."
                },
                {
                  q: "Как часто можно делать рентген-снимки?",
                  a: "При необходимости рентген-снимки можно делать достаточно часто. Современное цифровое оборудование в стоматологии Альтамед Голицино обеспечивает минимальную лучевую нагрузку, которая не представляет опасности для здоровья."
                },
                {
                  q: "Можно ли делать рентген беременным?",
                  a: "В первом триместре беременности рентген-диагностику стараются избегать. При острой необходимости используется защита и минимальные дозы облучения. В клинике «Альтамед Голицино» Альтамед Голицино мы индивидуально подходим к каждому случаю и консультируемся с пациенткой."
                }
              ].map((faq, idx) => (
