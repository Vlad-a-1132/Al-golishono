    ...
    <div className="flex flex-col min-h-full bg-white mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Пародонтология в клинике «Альтамед Голицыно»
              </h1>
              <p className="text-lg md:text-xl mb-8 text-emerald-100">
                Диагностика и лечение заболеваний десен у взрослых и детей в Альтамед Голицыно
              </p>
            </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 text-center">
              Что такое пародонтология в стоматологии Альтамед Голицыно
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Методы лечения в «Альтамед Голицыно»</h3>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
            Услуги пародонтологии в Альтамед Голицыно
          </h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Симптомы заболеваний пародонта в Альтамед Голицыно
            </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Почему важно лечить пародонтит в Альтамед Голицыно
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  title: "Предотвратить потерю зубов",
                  text: "Запущенный пародонтит приводит к расшатыванию и выпадению зубов. Своевременное лечение в стоматологии Альтамед Голицыно позволяет сохранить зубы и восстановить здоровье десен.",
                  icon: "🦷"
                },
                {
                  title: "Улучшить общее здоровье",
                  text: "Заболевания пародонта связаны с риском сердечно-сосудистых заболеваний, диабета. Лечение в «Альтамед Голицыно» Альтамед Голицыно положительно влияет на весь организм.",
                  icon: "❤️"
                },
                {
                  title: "Восстановить эстетику",
                  text: "Здоровые десны — важная часть красивой улыбки. Лечение пародонтита в Альтамед Голицыно восстанавливает естественный вид десен и зубов.",
                  icon: "✨"
                },
                {
                  title: "Избавиться от дискомфорта",
                  text: "Воспаление десен вызывает боль, кровоточивость, неприятный запах. Профессиональное лечение в клинике Альтамед Голицыно устраняет все эти симптомы.",
                  icon: "😊"
                }
              ].map((item, idx) => (
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Стоимость лечения заболеваний пародонта в стоматологии Альтамед Голицыно
            </h2>
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Цены на пародонтологическое лечение в клинике «Альтамед Голицыно» Альтамед Голицыно зависят от стадии заболевания и выбранного метода лечения. Пародонтология в Альтамед Голицыно включает лечение гингивита, пародонтита, профессиональную гигиену и хирургические методы.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="bg-green-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Консервативное лечение в Альтамед Голицыно</h3>
                  <p className="text-gray-600 mb-3">
                    Консервативное лечение заболеваний пародонта в стоматологии Альтамед Голицыно включает профессиональную гигиену, кюретаж пародонтальных карманов и медикаментозную терапию. Эти методы эффективны на ранних стадиях заболеваний.
                  </p>
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start">
                ...
                <div className="bg-emerald-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Хирургическое лечение в Альтамед Голицыно</h3>
                  <p className="text-gray-600 mb-3">
                    Хирургические методы в пародонтологии Альтамед Голицыно применяются при запущенных формах заболеваний. Открытый кюретаж, лоскутные операции и закрытие рецессий позволяют восстановить здоровье десен.
                  </p>
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start">
              ...
              <p className="mt-6 text-gray-600">
                Точную стоимость пародонтологического лечения в стоматологии Альтамед Голицыно можно узнать после консультации и диагностики. Мы предлагаем комплексные программы лечения с учетом стадии заболевания. Запишитесь на прием в «Альтамед Голицыно» Альтамед Голицыно для получения детальной информации.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Заболевания пародонта в стоматологии Альтамед Голицыно
            </h2>
            <div className="space-y-8">
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Гингивит в Альтамед Голицыно</h3>
                <p className="text-gray-700 mb-4">
                  Гингивит — это начальная стадия заболевания пародонта, проявляющаяся воспалением десен. Лечение гингивита в стоматологии Альтамед Голицыно включает профессиональную гигиену, удаление зубного налета и камня. В клинике «Альтамед Голицыно» Альтамед Голицыно лечение гингивита проводится на ранних стадиях, что предотвращает развитие пародонтита.
                </p>
                <p className="text-gray-700">
                  Симптомы гингивита: кровоточивость десен, покраснение, отечность. При своевременном лечении в стоматологии Альтамед Голицыно гингивит полностью излечим. Регулярная профессиональная гигиена в клинике Альтамед Голицыно помогает предотвратить развитие заболевания.
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Пародонтит в Альтамед Голицыно</h3>
                <p className="text-gray-700 mb-4">
                  Пародонтит — это воспаление тканей пародонта с образованием пародонтальных карманов и разрушением костной ткани. Лечение пародонтита в стоматологии Альтамед Голицыно требует комплексного подхода: профессиональная гигиена, кюретаж карманов, медикаментозная терапия.
                </p>
                <p className="text-gray-700">
                  При запущенных формах пародонтита в клинике «Альтамед Голицыно» Альтамед Голицыно применяются хирургические методы: открытый кюретаж, лоскутные операции. Лечение пародонтита в стоматологии Альтамед Голицыно направлено на остановку разрушения тканей и сохранение зубов.
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Пародонтоз в Альтамед Голицыно</h3>
                <p className="text-gray-700 mb-4">
                  Пародонтоз — это дистрофическое заболевание пародонта, характеризующееся убылью костной ткани без воспаления. Лечение пародонтоза в стоматологии Альтамед Голицыно включает комплекс мер: профессиональную гигиену, физиотерапию, медикаментозное лечение.
                </p>
                <p className="text-gray-700">
                  В клинике «Альтамед Голицыно» Альтамед Голицыно лечение пародонтоза направлено на замедление процесса разрушения тканей. Регулярные поддерживающие курсы лечения в стоматологии Альтамед Голицыно помогают сохранить зубы и замедлить прогрессирование заболевания.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Профилактика заболеваний пародонта в стоматологии Альтамед Голицыно
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Домашний уход</h3>
                <p className="text-gray-700 mb-4">
                  Правильный домашний уход в пародонтологии Альтамед Голицыно — это основа профилактики заболеваний десен. Регулярная чистка зубов, использование зубной нити и ирригатора помогают удалять налет и предотвращать воспаление десен.
                </p>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Регулярная профессиональная гигиена в пародонтологии Альтамед Голицыно необходима для удаления зубного камня и налета, которые невозможно удалить в домашних условиях. В клинике «Альтамед Голицыно» Альтамед Голицыно мы рекомендуем профессиональную чистку каждые 6 месяцев.
                </p>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-emerald-600 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <li className="flex items-start">
                    ...
                    Регулярные осмотры пародонтолога в Альтамед Голицыно
                  </li>
                </ul>
              </div>
            </div>
            <div className="mt-8 bg-white rounded-lg p-6 border-2 border-green-200">
              <p className="text-gray-700 text-lg leading-relaxed">
                Профилактика заболеваний пародонта в клинике «Альтамед Голицыно» Альтамед Голицыно — это комплекс мер, направленных на сохранение здоровья десен. Регулярная профессиональная гигиена в стоматологии Альтамед Голицыно в сочетании с правильным домашним уходом позволяет предотвратить развитие гингивита и пародонтита. Специалисты пародонтологии Альтамед Голицыно обучают пациентов правильным техникам ухода и подбирают индивидуальные программы профилактики.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              <h2 className="text-3xl font-bold text-gray-900">Пародонтолог в Альтамед Голицыно: почему выбирают нас</h2>
              <p>
                Клиника «Альтамед Голицыно» предлагает услуги пародонтологии в Альтамед Голицыно — лечение заболеваний десен,
              ...
              <p>
                Прозрачные цены позволяют планировать бюджет — стоимость пародонтологии в Альтамед Голицыно
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Отзывы пациентов о пародонтологе в Альтамед Голицыно
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                После лечения в Голицыно пациенты отмечают отсутствие дискомфорта; пародонтологи дают
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Частые вопросы о пародонтологе в Альтамед Голицыно
          </h2>
          ...
          <div className="bg-gradient-to-r from-[#4A5568] to-[#5A6474] rounded-[20px] p-8 md:p-12 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Пародонтолог в Альтамед Голицыно — начните с консультации
              </h2>
              <p className="text-white/90 text-sm md:text-base leading-relaxed">
                Запишитесь на консультацию в клинику «Альтамед Голицыно», чтобы узнать стоимость лечения заболеваний десен,
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "Клиника «Альтамед Голицыно» — пародонтология в Альтамед Голицыно",
                ...
                description:
                  "Пародонтология в Альтамед Голицыно: лечение заболеваний десен, пародонтита, гингивита. Профессиональная чистка, шинирование зубов. Опытные пародонтологи в клинике «Альтамед Голицыно».",
                sameAs: [
