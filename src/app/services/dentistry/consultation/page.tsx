  ...
  const fullServicesData = [
    {
      ...
      services: [
        ...
        { code: "", name: "Прием (осмотр, консультация) врача-стоматолога-терапевта первичный (составление плана лечения по данным диагностики) 1ед.", price: 2500 },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                современные методы диагностики и учитываем индивидуальные
            ...
            <div className="bg-gray-50 rounded-[20px] p-6 shadow-md border-l-4 border-[#4A5568]">
              ...
              <ul className="space-y-3 text-gray-700 text-sm md:text-base leading-relaxed">
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-[#4A5568] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Консультация по результатам диагностики для точного планирования сложных случаев лечения.
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-[#4A5568] rounded-full mt-2 mr-3 flex-shrink-0"></span>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                Используем рентген-диагностику и визуальный осмотр для комплексной оценки
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  text: "Используем передовое стоматологическое оборудование для точной диагностики и качественного лечения. Рентген, современные материалы.",
                  icon: "🔬"
                },
                {
          ...
          <div className="space-y-4">
            <details className="group bg-gray-50 rounded-[20px] shadow-md border border-gray-100">
              ...
              <div className="px-6 pb-4 text-gray-700 leading-relaxed">
                ...
                с составлением плана лечения по данным диагностики — 2 500 ₽. Окончательная цена формируется
            ...
            <details className="group bg-gray-50 rounded-[20px] shadow-md border border-gray-100">
              ...
              <div className="px-6 pb-4 text-gray-700 leading-relaxed">
                ...
                врач может назначить дополнительные исследования (например, рентген).
              </div>
            </details>
            <details className="group bg-gray-50 rounded-[20px] shadow-md border border-gray-100">
              <summary className="cursor-pointer px-6 py-4 flex items-center justify-between text-left">
            ...
            <details className="group bg-gray-50 rounded-[20px] shadow-md border border-gray-100">
              ...
              <div className="px-6 pb-4 text-gray-700 leading-relaxed">
                ...
                результаты предыдущих обследований (если есть). Если у вас есть рентген-снимки,
                возьмите их с собой.
              </div>
            </details>
          </div>
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                description:
                  "Консультация стоматолога в Альтамед Голицыно: первичный и повторный прием, осмотр полости рта, составление плана лечения, оформление справок и доступные цены.",
                sameAs: [
