    ...
    <div className="flex flex-col min-h-full bg-white mx-auto">
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              Терапевтическая стоматология в Одинцово — лечение зубов без боли в «<span className="italic">Альтамед-с</span>»
            </h1>
            <p className="text-gray-600 mt-2 px-4 md:px-0 text-sm md:text-base">
              Современное лечение кариеса, пульпита и периодонтита в клинике «Альтамед-с» Одинцово. Качественная стоматологическая помощь по доступным ценам.
            </p>
          </header>
          ...
          <div className="mb-8">
            <div className="block md:hidden w-full h-[300px] flex flex-col rounded-[20px] overflow-hidden shadow-md mx-auto relative">
              ...
              <div className="relative z-10 bg-white p-4 flex flex-col justify-between items-start gap-3 mt-auto">
                <div className="text-black font-medium text-sm">Реставрация зубов в Одинцово</div>
                <Link 
            ...
            <div className="hidden md:block h-[445px] relative overflow-hidden rounded-[20px] shadow-lg">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-start p-8 md:p-12 text-black z-10">
                <h2 className="text-2xl md:text-4xl font-bold mb-4">Реставрация зубов в Одинцово</h2>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 text-center">
              Что такое терапевтическая стоматология в Одинцово
            </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
            Услуги терапевтической стоматологии в Одинцово
          </h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Этапы лечения в терапевтической стоматологии Одинцово
            </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Почему важно лечить зубы своевременно в Одинцово
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  title: "Предотвращение осложнений",
                  text: "Своевременное лечение кариеса предотвращает развитие пульпита и периодонтита, которые требуют более сложного и дорогостоящего лечения. Раннее обращение к стоматологу в Одинцово позволяет решить проблему быстро и без осложнений.",
                  icon: "🦷"
                },
                {
                  title: "Сохранение зубов",
                  text: "Лечение на ранней стадии позволяет сохранить собственные зубы и избежать необходимости их удаления, протезирования или имплантации. В клинике «Альтамед-с» Одинцово мы делаем всё возможное для сохранения ваших зубов.",
                  icon: "💎"
                },
                {
                  title: "Экономия средств",
                  text: "Лечение кариеса обходится значительно дешевле, чем устранение осложнений. Регулярные профилактические осмотры в стоматологии Одинцово помогают выявить проблемы на ранней стадии и сэкономить деньги.",
                  icon: "💰"
                },
                {
                  title: "Здоровье организма",
                  text: "Больные зубы влияют на работу желудочно-кишечного тракта, могут стать источником хронических инфекций и негативно влиять на иммунную систему. Лечение зубов в Одинцово — это забота о здоровье всего организма.",
                  icon: "❤️"
                }
              ].map((item, idx) => (
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Современные методы лечения в терапевтической стоматологии Одинцово
            </h2>
            <div className="space-y-6">
              {[
                {
                  title: "Лечение кариеса без сверления",
                  desc: "В клинике «Альтамед-с» Одинцово применяются современные методики лечения начального кариеса с использованием инфильтрации и реминерализации, что позволяет избежать препарирования зуба.",
                ...
                },
                {
                  ...
                  desc: "Использование стоматологического микроскопа при лечении корневых каналов позволяет врачам стоматологии Одинцово видеть мельчайшие детали и обеспечить максимально качественное лечение.",
                ...
                },
                {
                  ...
                  desc: "Использование лазера в терапевтической стоматологии Одинцово позволяет проводить лечение более щадящим способом, уменьшая болезненные ощущения и сокращая период восстановления.",
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Когда обращаться к терапевту-стоматологу в Одинцово
            </h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Почему выбирают терапевтическую стоматологию «Альтамед-с» в Одинцово
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                {
                  ...
                  desc: "Используем новейшее диагностическое и лечебное оборудование для максимально точного и эффективного лечения зубов в Одинцово."
                },
                {
                  icon: "👨‍⚕️",
                  title: "Опытные врачи",
                ...
                },
                {
                  ...
                  desc: "Прозрачное ценообразование и оптимальное соотношение цены и качества. Лечение зубов в Одинцово стало доступнее."
                },
                {
                  icon: "🎯",
                ...
                },
                {
                  ...
                  desc: "Работаем в удобное для вас время, включая выходные дни. Записаться на прием к стоматологу в Одинцово можно онлайн."
                },
                {
                  icon: "📍",
                  title: "Удобное расположение",
                  desc: "Клиника «Альтамед-с» находится в центре Одинцово с удобной парковкой и доступностью общественного транспорта."
                }
              ].map((item, idx) => (
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Стоимость терапевтического лечения в стоматологии Одинцово
            </h2>
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Цены на терапевтическое лечение в клинике «Альтамед-с» Одинцово формируются с учетом сложности процедуры, используемых материалов и объема работы. Мы предлагаем прозрачное ценообразование без скрытых доплат.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="bg-emerald-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Лечение кариеса в Одинцово</h3>
                  <p className="text-gray-600 mb-3">
                    Стоимость лечения кариеса в стоматологии Одинцово зависит от стадии заболевания. Лечение поверхностного кариеса обойдется дешевле, чем лечение глубокого поражения. Цена также зависит от выбранного пломбировочного материала.
                  </p>
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start">
                ...
                <div className="bg-blue-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Лечение пульпита в Одинцово</h3>
                  <p className="text-gray-600 mb-3">
                    Лечение пульпита требует эндодонтического лечения корневых каналов. Цена зависит от количества каналов и используемых материалов. В нашей стоматологии Одинцово мы используем современные методики.
                  </p>
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start">
              ...
              <p className="mt-6 text-gray-600">
                Точную стоимость лечения в стоматологии Одинцово можно узнать после консультации и диагностики. Мы предлагаем рассрочку оплаты и скидки при комплексном лечении. Запишитесь на прием в «Альтамед-с» Одинцово для получения детальной информации о ценах.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Подробное описание услуг терапевтической стоматологии в Одинцово
            </h2>
            <div className="space-y-8">
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Лечение кариеса в Одинцово</h3>
                <p className="text-gray-700 mb-4">
                  Кариес — это самое распространенное заболевание зубов. В клинике «Альтамед-с» Одинцово лечение кариеса проводится с использованием современных материалов и технологий. Процесс включает в себя удаление пораженных тканей, обработку полости специальными растворами и установку пломбы, которая восстанавливает форму и функцию зуба.
                </p>
                <p className="text-gray-700">
                  Наши стоматологи в Одинцово используют композитные материалы светового отверждения, которые позволяют создавать пломбы, неотличимые от естественных зубов. Лечение проводится под местной анестезией, что обеспечивает полное отсутствие болевых ощущений.
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Лечение пульпита в стоматологии Одинцово</h3>
                <p className="text-gray-700 mb-4">
                  Пульпит — воспаление сосудисто-нервного пучка зуба, требующее эндодонтического лечения. В нашей стоматологии Одинцово лечение пульпита проводится с использованием эндодонтических инструментов и специальных материалов для пломбирования каналов.
                </p>
                <p className="text-gray-700">
                  Процедура включает очистку и обработку корневых каналов, их дезинфекцию и герметичное пломбирование. Лечение пульпита в Одинцово позволяет сохранить зуб и избежать его удаления. Мы используем современные методы обтурации каналов, обеспечивающие долгосрочный результат.
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Профессиональная гигиена в Одинцово</h3>
                <p className="text-gray-700 mb-4">
                  Регулярная профессиональная чистка зубов в стоматологии Одинцово необходима для поддержания здоровья полости рта. В клинике «Альтамед-с» Одинцово мы используем современные методы: ультразвуковую чистку и технологию Air Flow для удаления налета и зубного камня.
                </p>
                <p className="text-gray-700">
                  Профессиональная гигиена в Одинцово включает не только удаление отложений, но и полировку поверхности зубов, фторирование для укрепления эмали. Регулярные процедуры помогают предотвратить развитие кариеса и заболеваний десен.
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Реставрация зубов в Одинцово</h3>
                <p className="text-gray-700 mb-4">
                  Эстетическая реставрация зубов в стоматологии Одинцово позволяет восстановить не только функцию, но и внешний вид зуба. Наши врачи используют композитные материалы, которые идеально подбираются под цвет естественных зубов.
                </p>
                <p className="text-gray-700">
                  Реставрация в клинике «Альтамед-с» Одинцово применяется при сколах, трещинах, изменении цвета зубов. Современные материалы обеспечивают не только эстетику, но и прочность восстановленного зуба на долгие годы.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Профилактика кариеса и заболеваний зубов в Одинцово
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-lg p-6">
                ...
                <ul className="space-y-3 text-gray-700">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Использование фторсодержащих паст, рекомендованных стоматологом в Одинцово</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-emerald-600 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Профессиональная профилактика в Одинцово</h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-blue-600 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Профессиональная чистка зубов в клинике «Альтамед-с» Одинцово раз в 6 месяцев</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-blue-600 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Регулярные профилактические осмотры в стоматологии Одинцово</span>
                  </li>
                </ul>
              </div>
            </div>
            <div className="mt-8 bg-white rounded-lg p-6 border-2 border-emerald-200">
              <p className="text-gray-700 text-lg leading-relaxed">
                Правильная профилактика заболеваний зубов в Одинцово позволяет избежать необходимости сложного и дорогостоящего лечения. Специалисты клиники «Альтамед-с» Одинцово разработают индивидуальную программу профилактики, учитывающую особенности вашего организма и образ жизни. Регулярное наблюдение у стоматолога в Одинцово — залог здоровья ваших зубов на долгие годы.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Часто задаваемые вопросы о терапевтической стоматологии в Одинцово
            </h2>
            <div className="space-y-4">
              {[
                {
                  q: "Как часто нужно посещать стоматолога-терапевта в Одинцово?",
                  a: "Рекомендуется посещать стоматолога дважды в год для профилактического осмотра и профессиональной чистки. Это позволяет выявить проблемы на ранней стадии и предотвратить развитие серьезных заболеваний. В клинике «Альтамед-с» Одинцово мы предлагаем комплексные программы профилактики."
                },
                {
                  q: "Больно ли лечить кариес с анестезией?",
                  a: "Современная местная анестезия полностью исключает болевые ощущения во время лечения кариеса. Пациент чувствует только легкое давление от инструментов. В нашей стоматологии Одинцово мы используем только качественные обезболивающие препараты."
                },
                {
                  q: "Сколько прослужит пломба после лечения кариеса?",
                  a: "Срок службы пломбы зависит от материала и качества лечения. Современные композитные пломбы при правильном уходе могут прослужить 10-15 лет и более. В клинике «Альтамед-с» Одинцово мы предоставляем гарантию на все виды пломбирования."
                },
                {
                  q: "Можно ли вылечить пульпит без удаления нерва?",
                  a: "На ранней стадии пульпита возможно сохранение нерва с помощью биологического метода лечения. Однако при глубоком поражении требуется эндодонтическое лечение с удалением пульпы. В нашей стоматологии Одинцово врач проведет диагностику и выберет оптимальный метод."
                },
                {
                  q: "Что делать при острой зубной боли в Одинцово?",
                  a: "При острой боли нужно как можно скорее обратиться к стоматологу. До визита можно принять обезболивающее (ибупрофен, парацетамол). Клиника «Альтамед-с» Одинцово принимает пациентов с острой болью в день обращения."
                },
                {
                  q: "Отбеливание зубов вредит эмали?",
                  a: "Современные методы отбеливания безопасны для эмали при правильном выполнении процедуры. В нашей стоматологии Одинцово мы используем только проверенные методики и препараты, предварительно оценивая состояние эмали пациента."
                }
              ].map((faq, idx) => (
