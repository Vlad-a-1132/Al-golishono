...
export default function AestheticPage() {
  ...
  // Полный список услуг эстетической стоматологии
  const fullServicesData = [
    {
      subtitle: "Эстетическая стоматология",
      services: [
        { code: "", name: "Отбеливание зубов ZOOM4 / ПРОФЕССИОНАЛЬНОЕ ОТБЕЛИВАНИЕ ЗУБОВ СИСТЕМОЙ PHILIPS ZOOM ЗОНА УЛЫБКИ", price: 36750 }
      ]
    }
  ];
  ...
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Эстетическая стоматология в клинике «Альтамед Голицыно»
              </h1>
              <p className="text-lg md:text-xl mb-8 text-emerald-100">
                Профессиональное отбеливание зубов системой PHILIPS ZOOM4 в Альтамед Голицыно
              </p>
            </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              <h2 className="text-3xl font-bold text-gray-900">Эстетическая стоматология в Альтамед Голицыно: почему выбирают нас</h2>
              <p>
                Клиника «Альтамед Голицыно» предлагает услуги эстетической стоматологии в Альтамед Голицыно — профессиональное
              ...
              <p>
                Прозрачные цены позволяют планировать бюджет — стоимость эстетической стоматологии в Альтамед Голицыно
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Преимущества эстетической стоматологии в «Альтамед Голицыно»</h2>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 text-center">
              Отбеливание зубов ZOOM4 в Альтамед Голицыно
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <p className="text-gray-600">
                  Процедуры, направленные в первую очередь на улучшение внешнего вида зубов. Отбеливание, реставрация, виниры — все для создания идеальной улыбки в Альтамед Голицыно.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
            Услуги эстетической стоматологии в Альтамед Голицыно
          </h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Эстетическая стоматология в Альтамед Голицыно: цены и отзывы пациентов
          </h2>
          <div className="space-y-4 text-gray-700 leading-relaxed text-sm md:text-base mb-6">
            <p>
              Стоматология «Альтамед Голицыно» — клиника, где эстетическая стоматология в Альтамед Голицыно проводится
            ...
            <p>
              ...
              где «эстетическая стоматология Голицыно» — это не просто слоган, а качественная услуга, записывайтесь
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Отзывы пациентов об эстетической стоматологии в Альтамед Голицыно
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                После отбеливания в Альтамед Голицыно пациенты отмечают минимальную чувствительность; врачи дают
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Частые вопросы об эстетической стоматологии в Альтамед Голицыно
          </h2>
            ...
            <details className="group bg-gray-50 rounded-[20px] shadow-md border border-gray-100">
              <summary className="cursor-pointer px-6 py-4 flex items-center justify-between text-left">
                <span className="text-lg font-semibold text-gray-900 group-open:text-emerald-700 transition-colors duration-300">
                  Сколько стоит отбеливание зубов ZOOM4 в Альтамед Голицыно?
                </span>
                <svg
          ...
          <div className="bg-gradient-to-r from-[#4A5568] to-[#5A6474] rounded-[20px] p-8 md:p-12 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Эстетическая стоматология в Альтамед Голицыно — начните с консультации
              </h2>
              <p className="text-white/90 text-sm md:text-base leading-relaxed">
                Запишитесь на консультацию в клинику «Альтамед Голицыно», чтобы узнать стоимость отбеливания зубов,
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "Клиника «Альтамед Голицыно» — эстетическая стоматология в Альтамед Голицыно",
                ...
                description:
                  "Эстетическая стоматология в Альтамед Голицыно: профессиональное отбеливание зубов системой PHILIPS ZOOM4, реставрация, виниры и другие процедуры для создания идеальной улыбки.",
                sameAs: [
