...
export default function RemovableAppliancesPage() {
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <p className="text-gray-700 mb-6 leading-relaxed text-center">
            Стоимость лечения съемными аппаратами в клинике «Альтамед-С» формируется в зависимости от сложности случая,
