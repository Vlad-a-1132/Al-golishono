        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Рентгенография в клинике «Альтамед Голицыно» Альтамед Голицыно включает различные виды исследований: от прицельных снимков до панорамной рентгенографии. Цены зависят от вида исследования и объема работы.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                рентгенографию для точной диагностики. Мы применяем современное цифровое
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                description:
                  "Рентгенография в Альтамед Голицыно: прицельные снимки и панорамная рентгенография для точной диагностики в стоматологии.",
                sameAs: [
