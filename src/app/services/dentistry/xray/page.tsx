    ...
    <div className="flex flex-col min-h-full bg-white mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Рентгенография в клинике «Альтамед Голицыно»
              </h1>
              <p className="text-lg md:text-xl mb-8 text-emerald-100">
                Цифровая рентгенография зубов и челюстей для точной диагностики в Альтамед Голицыно
              </p>
            </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 text-center">
              Виды рентгенографии в стоматологии Альтамед Голицыно
            </h2>
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Прицельный снимок (радиовизиография)</h3>
                <p className="text-gray-600 mb-4">
                  Самый распространенный вид рентгенографии в стоматологии Альтамед Голицыно. Позволяет получить изображение одного или нескольких рядом стоящих зубов. Используется для диагностики кариеса, оценки состояния корневых каналов, контроля качества лечения. В клинике «Альтамед Голицыно» Альтамед Голицыно мы используем современные цифровые визиографы с минимальной лучевой нагрузкой.
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Ортопантомограмма (ОПТГ, панорамный снимок)</h3>
                <p className="text-gray-600 mb-4">
                  Обзорный снимок всех зубов верхней и нижней челюсти. Необходим для общего осмотра, планирования лечения, выявления скрытых патологий, ретинированных зубов. Панорамный снимок в Альтамед Голицыно выполняется за несколько секунд и дает полную картину состояния зубов.
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Компьютерная томография (КТ)</h3>
                <p className="text-gray-600 mb-4">
                  Трехмерная диагностика, позволяющая получить объемное изображение зубов и челюстей. Незаменима для планирования имплантации, ортодонтического лечения, диагностики сложных случаев. КТ в стоматологии Альтамед Голицыно — это точность и уверенность в лечении.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
            Прайс-лист рентгенографии в Альтамед Голицыно
          </h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Преимущества цифровой рентгенографии в Альтамед Голицыно
            </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Стоимость рентгенографии в стоматологии Альтамед Голицыно
            </h2>
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Рентгенография в клинике «Альтамед Голицыно» Альтамед Голицыно включает различные виды исследований: от прицельных снимков до панорамной рентгенографии и КТ. Цены зависят от вида исследования и объема работы.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="bg-teal-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Базовые рентген-исследования в Альтамед Голицыно</h3>
                  <p className="text-gray-600 mb-3">
                    Базовые виды рентгенографии в стоматологии Альтамед Голицыно включают прицельные снимки отдельных зубов и панорамную рентгенографию всех зубов. Эти исследования необходимы для первичной диагностики и планирования лечения.
                  </p>
                ...
                <div className="bg-cyan-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Компьютерная томография в Альтамед Голицыно</h3>
                  <p className="text-gray-600 mb-3">
                    КТ в стоматологии Альтамед Голицыно — это наиболее информативный метод диагностики, дающий трехмерное изображение. Используется для сложных случаев: имплантация, ортодонтия, хирургия.
                  </p>
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start">
              ...
              <p className="mt-6 text-gray-600">
                Точную стоимость рентгенографии в стоматологии Альтамед Голицыно можно узнать после консультации. Мы предлагаем комплексные программы диагностики по доступным ценам. Запишитесь на прием в «Альтамед Голицыно» Альтамед Голицыно для получения детальной информации.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              <h2 className="text-3xl font-bold text-gray-900">Рентгенография в Альтамед Голицыно: почему выбирают нас</h2>
              <p>
                Клиника «Альтамед Голицыно» предлагает услуги рентгенографии в Альтамед Голицыно — прицельные снимки, панорамную
              ...
              <p>
                Прозрачные цены позволяют планировать бюджет — стоимость рентгенографии в Альтамед Голицыно
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-[20px] shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
              Важность рентген-диагностики в современной стоматологии Альтамед Голицыно
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Точная диагностика скрытых патологий</h3>
                <p className="text-gray-700 mb-4">
                  Рентгенография в стоматологии Альтамед Голицыно позволяет выявить патологии, которые невозможно увидеть при визуальном осмотре: кариес между зубами, патологии корневых каналов, кисты, гранулемы. В клинике «Альтамед Голицыно» Альтамед Голицыно рентген-диагностика является обязательной частью комплексного обследования.
                </p>
                <p className="text-gray-700">
                  Современное цифровое оборудование в стоматологии Альтамед Голицыно обеспечивает высокое качество изображений и минимальную лучевую нагрузку, что делает диагностику безопасной для пациентов всех возрастов.
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Планирование и контроль лечения</h3>
                <p className="text-gray-700 mb-4">
                  Рентген-снимки в клинике «Альтамед Голицыно» Альтамед Голицыно необходимы не только для диагностики, но и для планирования лечения и контроля его результатов. Врачи используют снимки для оценки качества пломбирования каналов, установки имплантов, результатов ортодонтического лечения.
                </p>
                <p className="text-gray-700">
                  Регулярная рентген-диагностика в стоматологии Альтамед Голицыно позволяет контролировать состояние зубов и своевременно выявлять проблемы, что обеспечивает долгосрочный успех лечения.
                </p>
              </div>
            </div>
            <div className="mt-8 bg-white rounded-lg p-6 border-2 border-teal-200">
              <p className="text-gray-700 text-lg leading-relaxed">
                Рентгенография в клинике «Альтамед Голицыно» Альтамед Голицыно — это незаменимый инструмент современной стоматологии. Без рентген-диагностики невозможно провести качественное лечение: врач видит только поверхность зубов, а рентген показывает внутреннюю структуру и скрытые патологии. Опытные рентгенологи стоматологии Альтамед Голицыно проводят все виды исследований с высокой точностью, обеспечивая врачам полную информацию для принятия правильных решений.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Отзывы пациентов о рентгенографии в Альтамед Голицыно
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                После рентгенографии в Альтамед Голицыно пациенты отмечают отсутствие дискомфорта; врачи дают
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Частые вопросы о рентгенографии в Альтамед Голицыно
          </h2>
          ...
          <div className="bg-gradient-to-r from-[#4A5568] to-[#5A6474] rounded-[20px] p-8 md:p-12 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Рентгенография в Альтамед Голицыно — получите точную диагностику
              </h2>
              <p className="text-white/90 text-sm md:text-base leading-relaxed">
                Запишитесь на рентгенографию в клинику «Альтамед Голицыно», чтобы получить качественные снимки
                для точной диагностики и планирования лечения.
              </p>
            </div>
            <Link
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "Клиника «Альтамед Голицыно» — рентгенография в Альтамед Голицыно",
                ...
                description:
                  "Рентгенография в Альтамед Голицыно: прицельные снимки, панорамная рентгенография, компьютерная томография для точной диагностики в стоматологии.",
                sameAs: [
