          ...
          <div className="bg-white rounded-[20px] shadow-lg p-8 md:p-12">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-6">
                ...
                <p className="text-gray-700">
                  Перед имплантацией в стоматологии Альтамед Голицыно обязательно проводится КТ для оценки костной ткани. При недостатке кости выполняется костная пластика или синус-лифтинг. Имплантация в клинике Альтамед Голицыно позволяет восстановить как один зуб, так и весь зубной ряд с пожизненной гарантией.
                </p>
              </div>
              <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-lg p-6">
