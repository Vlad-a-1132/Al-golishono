...
export const metadata: Metadata = {
  ...
  description: 'Профессиональная стоматология в Одинцово. Лечение кариеса, имплантация зубов, протезирование, отбеливание, детская стоматология, ортодонтия, пародонтология. Современное оборудование, опытные врачи, безболезненное лечение. Запись на прием в клинике Альтамед-с Одинцово.',
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Стоматология в Альтамед-с Одинцово',
      },
    ],
  },
  twitter: {
