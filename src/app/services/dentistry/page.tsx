  ...
  const serviceCategories = [
    {
      ...
      subtitle: "Приемы и осмотры всех врачей (терапевт, хирург, ортопед, ортодонт, детский), Рентген (прицельный снимок, панорамный снимок - ОПТГ), ТРГ (телерентгенография)"
    },
    {
      id: "anesthesia",
      title: "Анестезия",
  ...
  useEffect(() => {
    const jsonLd = {
      ...
      "address": {
        ...
        "streetAddress": "Советская улица, 58",
        "postalCode": "143040"
      },
      "telephone": "+7 (495) 989-64-80",
