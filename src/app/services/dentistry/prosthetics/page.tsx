  ...
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Протезирование зубов в клинике «Альтамед Голицыно»
              </h1>
              <p className="text-lg md:text-xl mb-8 text-emerald-100">
                Коронки на имплантатах, металлокерамика и протез All-on-4 в Альтамед Голицыно
              </p>
            </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              <h2 className="text-3xl font-bold text-gray-900">Протезирование зубов в Альтамед Голицыно: почему выбирают нас</h2>
              <p>
                Клиника «Альтамед Голицыно» предлагает полный комплекс протезирования зубов в Альтамед Голицыно — от коронок
              ...
              <p>
                Прозрачные цены позволяют планировать бюджет — стоимость протезирования зубов в Альтамед Голицыно
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Преимущества протезирования в «Альтамед Голицыно»</h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Протезирование зубов в Альтамед Голицыно: цены и отзывы пациентов
          </h2>
          <div className="space-y-4 text-gray-700 leading-relaxed text-sm md:text-base mb-6">
            <p>
              Стоматология «Альтамед Голицыно» — клиника, где протезирование зубов в Голицыно проводится по международным
            ...
            <p>
              ...
              где «протезирование зубов Голицыно» — это не просто слоган, а качественная услуга, записывайтесь
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">
            Цены на протезирование зубов в Альтамед Голицыно
          </h2>
          <p className="text-gray-700 mb-6 leading-relaxed text-center">
            Стоимость протезирования зубов в клинике «Альтамед Голицыно» формируется в зависимости от вида протеза
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Отзывы пациентов о протезировании зубов в Альтамед Голицыно
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                После протезирования в Голицыно пациенты отмечают комфорт при ношении протезов; врачи дают
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Частые вопросы о протезировании зубов в Альтамед Голицыно
          </h2>
          ...
          <div className="bg-gradient-to-r from-[#4A5568] to-[#5A6474] rounded-[20px] p-8 md:p-12 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Протезирование зубов в Альтамед Голицыно — начните с консультации
              </h2>
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "Клиника «Альтамед Голицыно» — протезирование зубов в Альтамед Голицыно",
                ...
                description:
                  "Протезирование зубов в Альтамед Голицыно: коронки, мосты, съемные протезы, протезирование на имплантах, диоксид циркония и металлокерамика.",
                sameAs: [
