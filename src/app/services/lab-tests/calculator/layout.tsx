...
export const metadata: Metadata = {
  title: 'Калькулятор анализов - Рассчитать стоимость анализов | Альтамед Голицино',
  description: 'Калькулятор анализов - рассчитайте стоимость лабораторных анализов онлайн. Выберите нужные анализы и узнайте общую стоимость. Удобный инструмент для планирования обследования в медицинском центре Альтамед Голицино.',
  keywords: [
