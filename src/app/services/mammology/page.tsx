              ...
              >
                <Link href="/appointments" className="block">
                  <div className="h-48 relative">
                    <Image
                      src="/images/images allergoly/mamalogy.webp"
                      alt="Прием врача-онколога первичный"
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-black mb-2" itemProp="name">
                      Прием (осмотр, консультация) врача-онколога первичный
                    </h3>
                    <p className="text-gray-600 mb-4" itemProp="description">
                      Первичная консультация и осмотр у врача-онколога-маммолога
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-600 font-bold text-lg" itemProp="offers" itemScope itemType="https://schema.org/Offer">
                        <span itemProp="price">2 600 руб.</span>
                        <span itemProp="priceCurrency" content="RUB" className="sr-only">RUB</span>
                      </span>
                      <span className="bg-emerald-600 text-white px-4 py-2 rounded-full text-sm font-medium group-hover:bg-emerald-700 transition-colors">
                        Записаться
                      </span>
                    </div>
                  </div>
              ...
              >
                <Link href="/appointments" className="block">
                  <div className="h-48 relative">
                    <Image
                      src="/images/images allergoly/mamalogy.webp"
                      alt="Прием врача-онколога повторный"
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 mb-4" itemProp="description">
                      Повторная консультация у врача-онколога-маммолога
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-600 font-bold text-lg" itemProp="offers" itemScope itemType="https://schema.org/Offer">
