  ...
  return (
    <div className="flex flex-col bg-white">
      <section className="pt-4 md:pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-black">
            Снятие электрокардиограммы (ЭКГ) в Голицыно — исследование в медицинском центре Альтамед Голицыно
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="w-full md:w-1/2 text-gray-700 space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-black">Электрокардиография в Голицыно</h2>
              <p>
                Электрокардиография (ЭКГ) — метод регистрации электрической активности сердца. Исследование позволяет выявить нарушения ритма и проводимости, признаки ишемии, гипертрофию отделов сердца и другие изменения. В медицинском центре Альтамед Голицыно ЭКГ выполняется на современном оборудовании.
              </p>
              <p>
                Процедура занимает несколько минут, безболезненна и не требует специальной подготовки. Результаты выдаются в день обращения. В медицинском центре Альтамед Голицыно ЭКГ выполняется на современных электрокардиографах с цифровой регистрацией и возможностью расшифровки врачом функциональной диагностики.
              </p>
              <p>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Когда стоит сделать ЭКГ в Голицыно</h2>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Как проходит ЭКГ в Альтамед Голицыно</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Что показывает электрокардиограмма в Голицыно</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Врач функциональной диагностики медицинского центра Альтамед Голицыно при расшифровке ЭКГ оценивает:
          </p>
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            На основе этих данных формулируется заключение. При выявлении значимых изменений врач рекомендует дообследование (УЗИ сердца, Холтер, консультация кардиолога) или лечение. ЭКГ в Альтамед Голицыно — быстрый и информативный первый шаг в диагностике заболеваний сердца.
          </p>
        </div>
      </section>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Подготовка к ЭКГ в Голицыно</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            ЭКГ не имеет противопоказаний. Метод безопасен для детей, беременных и пожилых людей. В Альтамед Голицыно ЭКГ выполняется опытными специалистами; результат с расшифровкой выдаётся в день обращения.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Преимущества ЭКГ в Альтамед Голицыно</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
