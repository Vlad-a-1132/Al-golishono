...
export default function CTScanPage() {
  ...
  const faqItems = [
    {
      question: "Что такое КТ с контрастом?",
      answer: "КТ с контрастированием - это исследование с введением специального препарата, который улучшает визуализацию органов и сосудов. Контраст помогает выявить опухоли, воспалительные процессы и нарушения кровообращения."
    },
    {
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              КТ в клинике «<span className="italic">Альтамед-с</span>»
            </h1>
            <p className="text-gray-600 mt-2 px-4 md:px-0 text-sm md:text-base">
              Компьютерная томография в Одинцово
            </p>
          </header>
