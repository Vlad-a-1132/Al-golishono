...
const whyItems = [
  "Опытные врачи-хирурги и детский хирург",
  "Биопсии, пункции, малая хирургия",
  "Удаление новообразований, лечение ран",
  "Удобная запись и приём в Голицыно",
];

const symptoms = [
  "боли, отёки, покраснение кожи",
  "гнойные воспаления, фурункулы, абсцессы",
  "новообразования кожи, атеромы, папилломы",
  "раны, порезы, инородные тела",
  "вросший ноготь, мозоли",
  "послеоперационный уход и перевязки",
];

const helpsWith = [
  "приём и диспансерное наблюдение хирурга",
  "биопсии и пункции под контролем УЗИ",
  "вскрытие абсцессов, панариция, флегмон",
  "наложение повязок и швов",
  "удаление доброкачественных новообразований",
  "лечебные блокады и инъекции",
];

const procedures = [
  "биопсии (кожа, лимфоузлы, щитовидная железа)",
  "пункции суставов и мягких тканей",
  "хирургическая обработка ран",
  "удаление новообразований (ФОТЕК, сургитрон)",
  "наложение гипсовых и фиксирующих повязок",
];

const faqItems = [
  {
    q: "Какие услуги оказывает хирург?",
    a: "В «Альтамед Голицыно» проводятся приём врача-хирурга и детского хирурга, биопсии, пункции, наложение повязок, хирургическая обработка ран, удаление новообразований кожи, вскрытие панариция и флегмоны, лечебные блокады и другие манипуляции по прейскуранту.",
  },
  {
    q: "Принимает ли детский хирург?",
    a: "Да. В клинике ведут приём врачи-хирурги и детский хирург. Запись — через онлайн-регистратуру или по телефону клиники.",
  },
  {
    q: "Как записаться на приём?",
    a: "Запись — на сайте reg.altamed-golitsino.ru, по телефону +7 (495) 989-64-80 или через форму «Записаться в клинику» на этой странице. Клиника: Голицыно, Советская улица, 58.",
  },
];
...
function Breadcrumbs() {
  return (
    <nav className="flex text-sm text-gray-500" aria-label="Breadcrumb">
      ...
      <span className="mx-2">/</span>
      <span className="text-gray-800">Хирург</span>
    </nav>
  );
}
...
export default function SurgeryGolitsinoClient({
  services,
  priceFrom,
}: Props) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-white">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold leading-tight text-gray-900 md:text-4xl">
              Хирург в Голицыно — приём, операции и запись в «Альтамед
              Голицыно»
            </h1>
            <p className="mt-4 text-base leading-relaxed text-gray-600 md:text-lg">
              Приём врача-хирурга, биопсии и пункции, малая хирургия, удаление
              новообразований, лечение ран и гнойных воспалений — по
      ...
      <section id="reasons" className="scroll-mt-24 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            С чем хирург помогает разобраться
          </h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {helpsWith.map((item) => (
              <div
      ...
      <section id="procedures" className="scroll-mt-24 bg-gray-50 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            Процедуры
          </h2>
