  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <section className="pt-4 md:pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h1 className="text-2xl md:text-4xl font-bold text-black">
            Функциональная диагностика в Голицыно — исследования в медицинском центре Альтамед Голицыно
          </h1>
        </div>
      </section>
          ...
          <div className="bg-emerald-500 rounded-[20px] overflow-hidden">
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-1/2 p-6 md:p-8 text-white">
                <p className="mb-4">
                  Функциональная диагностика — комплекс методов исследования, направленных на оценку функционального состояния органов и систем организма в покое и при нагрузке. В медицинском центре Альтамед Голицыно исследования проводятся опытными специалистами на современном оборудовании.
                </p>
                <p className="mb-4">
                ...
                <p>
                  Исследования безопасны, безболезненны и высокоинформативны. Записаться на функциональную диагностику в Альтамед Голицыно можно через форму на сайте или по телефону.
                </p>
              </div>
      ...
      <section className="py-4">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">
            Преимущества функциональной диагностики в Альтамед Голицыно
          </h2>
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-[20px] p-6">
                ...
                <p className="text-gray-700 mt-4">
                  Функциональная диагностика в Альтамед Голицыно назначается терапевтом, кардиологом, пульмонологом или другим специалистом при наличии жалоб или в рамках профилактического обследования.
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="bg-gray-50 rounded-[20px] p-6">
                ...
                <p className="text-gray-700 mt-4">
                  Результаты исследований позволяют врачу поставить или уточнить диагноз, подобрать лечение и контролировать его эффективность. В Альтамед Голицыно расшифровку проводит специалист.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">
            Как проводятся исследования в Альтамед Голицыно
          </h2>
          <div className="space-y-4 text-gray-700">
            ...
            <p className="text-base md:text-lg">
              Большинство методов не требуют специальной подготовки. Перед ЭКГ рекомендуется избегать физических нагрузок. Подробные инструкции вы получите при записи на исследование в медицинском центре Альтамед Голицыно.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h3 className="text-2xl font-bold mb-4">Подготовка к исследованиям в Альтамед Голицыно</h3>
          <div className="text-gray-800 space-y-4">
            <p>
              Для ЭКГ и ЭхоКГ специальная подготовка не требуется. Перед ЭКГ желательно не переедать и не курить за 1–2 часа. Для холтеровского мониторирования в день исследования не рекомендуется принимать душ (устройство нельзя мочить). При записи на спирометрию или другие виды исследований администратор клиники Альтамед Голицыно сообщит индивидуальные рекомендации.
            </p>
            <p>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">
            Виды исследований в Альтамед Голицыно
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-sm md:text-base text-gray-700 mb-4">
            Стоимость указана за одно исследование и носит информационный характер. Актуальные цены уточняйте у администратора клиники Альтамед Голицыно.
          </p>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">
            Почему выбирают функциональную диагностику в Альтамед Голицыно
          </h2>
