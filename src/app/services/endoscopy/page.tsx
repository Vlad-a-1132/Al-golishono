  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              Эндоскопия в клинике «<span className="italic">Альтамед Голицино</span>»
            </h1>
            <p className="text-gray-600 mt-2 px-4 md:px-0 text-sm md:text-base">
              Эндоскопические исследования в Голицино
            </p>
          </header>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-4">
            Виды эндоскопических исследований в Голицино
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
            Клиника «Альтамед Голицино» в Голицино предлагает полный спектр эндоскопических исследований внутренних органов для точной диагностики заболеваний
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Полный спектр эндоскопических исследований и диагностических процедур в Голицино
            </p>
          </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="mb-8">
            <p className="text-gray-700 mb-4 leading-relaxed">
              <strong>Эндоскопия</strong> — это современный метод визуального исследования внутренних органов с помощью гибких эндоскопов, оснащенных миниатюрной видеокамерой высокого разрешения и источником света. В клинике «Альтамед Голицино» в Голицино эндоскопические исследования проводятся с использованием оборудования экспертного класса.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Основные преимущества эндоскопии в Голицино — возможность тщательного визуального осмотра слизистых оболочек органов желудочно-кишечного тракта, дыхательной системы, выявления патологических изменений на ранней стадии, проведения биопсии для гистологического исследования и даже выполнения лечебных манипуляций в режиме реального времени.
            </p>
            <div className="bg-white rounded-[20px] p-6 shadow-md border-l-4 border-[#6B8190]">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Преимущества эндоскопии в Голицино:</h3>
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Показания к эндоскопическому исследованию в Голицино</h2>
          ...
          <div className="bg-white rounded-[20px] shadow-lg p-8 mb-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                Гастроскопия в Голицино назначается для выявления причин следующих симптомов:
              </p>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Дополнительные процедуры при эндоскопии в Голицино</h2>
          <p className="text-gray-700 mb-6 text-center max-w-3xl mx-auto">
            Во время эндоскопического исследования в клинике «Альтамед Голицино» врач может выполнить диагностические и лечебные манипуляции без дополнительных оперативных вмешательств:
          </p>
