...
export const metadata: Metadata = {
  ...
  description: 'Гинеколог в Одинцово - профессиональная диагностика и лечение женских заболеваний. Кольпоскопия, УЗИ, ведение беременности. Запись на прием к гинекологу в клинике Альтамед-с Одинцово.',
  keywords: [
    'гинеколог Одинцово',
