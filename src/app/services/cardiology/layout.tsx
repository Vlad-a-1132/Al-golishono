...
export const metadata: Metadata = {
  ...
  description: 'Кардиолог в Одинцово - профессиональная диагностика и лечение заболеваний сердца и сосудов. ЭКГ, холтер, лечение гипертонии, аритмии. Запись на прием к кардиологу в клинике Альтамед-с Одинцово.',
  keywords: [
    'кардиолог Одинцово',
