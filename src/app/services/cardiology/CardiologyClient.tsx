...
const whyItems = [
  ...
  "ЭКГ, тредмил-тест и экспресс-анализ тропонинов",
  "Контроль артериального давления и интерпретация ЭКГ",
...
const symptoms = [
  ...
  "перебои, учащённое или замедленное сердцебиение",
  "повышенное или нестабильное давление",
  "головокружение и слабость",
  "профилактический осмотр и контроль хронических заболеваний",
];

const helpsWith = [
  "оценка жалоб и факторов риска сердечно-сосудистых заболеваний",
  "подбор обследований: ЭКГ, тредмил-тест, анализы",
  "контроль артериального давления",
  "расшифровка и интерпретация ЭКГ",
  "экспресс-исследование тропонинов при показаниях",
  "план наблюдения и лечения по клиническим рекомендациям",
];
...
const diagnostics = [
  ...
  "экспресс-исследование тропонинов I, T",
  "расшифровка и интерпретация данных ЭКГ",
];

const faqItems = [
  {
    q: "Когда обращаться к кардиологу?",
    a: "К кардиологу обращаются при болях или дискомфорте в груди, одышке, перебоях в работе сердца, повышенном давлении, головокружении, а также для профилактического осмотра и контроля хронических заболеваний сердца и сосудов.",
  },
  {
    q: "Какие обследования можно пройти в клинике?",
    a: "В «Альтамед Голицыно» доступны приём кардиолога, регистрация ЭКГ, расшифровка электрокардиографических данных, измерение артериального давления, экспресс-исследование тропонинов и электрокардиография с физической нагрузкой (тредмил-тест) по показаниям.",
  },
  {
    q: "Нужна ли подготовка к тредмил-тесту?",
    a: "Перед тредмил-тестом врач уточнит рекомендации: обычно требуется лёгкий приём пищи, удобная одежда и обувь, список принимаемых препаратов. Подробности сообщат при записи.",
  },
];
...
function Breadcrumbs() {
  return (
    <nav className="flex text-sm text-gray-500" aria-label="Breadcrumb">
      ...
      <span className="mx-2">/</span>
      <span className="text-gray-800">Кардиология</span>
    </nav>
  );
}
...
export default function CardiologyClient({ services, priceFrom }: Props) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-white">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold leading-tight text-gray-900 md:text-4xl">
              Кардиолог в Голицыно — приём, диагностика и запись в «Альтамед
              Голицыно»
            </h1>
            <p className="mt-4 text-base leading-relaxed text-gray-600 md:text-lg">
              Приём врача-кардиолога, ЭКГ, тредмил-тест, контроль давления и
              экспресс-анализ тропонинов. Помогаем оценить симптомы со стороны
              сердца и сосудов и подобрать план обследований.
            </p>
      ...
      <section id="reasons" className="scroll-mt-24 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            С чем кардиолог помогает разобраться
          </h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {helpsWith.map((item) => (
              <div
