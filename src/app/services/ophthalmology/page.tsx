...
export default function OphthalmologyPage() {
  ...
  // Услуги офтальмологии, организованные по категориям
  const ophthalmologyServices = [
    {
      category: 'Консультации офтальмолога',
      services: [
        { name: 'Прием (осмотр, консультация) врача-офтальмолога первичный', price: '3100' },
        { name: 'Прием (осмотр, консультация) врача-офтальмолога повторный', price: '2900' },
        { name: 'Консультация врача после проведенного аппаратного лечения', price: '700' }
      ]
    },
    {
      category: 'Диагностические исследования',
      services: [
        { name: 'Офтальмоскопия', price: '800' },
        { name: 'Скиаскопия', price: '500' },
        { name: 'Офтальмотонометрия', price: '700' },
        { name: 'Исследование аккомодации', price: '400' },
        { name: 'Биомикроскопия глаза', price: '500' },
        { name: 'Тонография глаз', price: '1300' },
        { name: 'Компьютерная периметрия', price: '1400' },
        { name: 'Авторефрактометрия с узким зрачком', price: '400' }
      ]
    },
    {
      category: 'Инъекции и процедуры',
      services: [
        { name: 'Пара- и ретробульбарные инъекции', price: '700' },
        { name: 'Субконъюнктивальная инъекция', price: '700' },
        { name: 'Удаление инородного тела из переднего сегмента глаза', price: '2700' }
      ]
    },
    {
      category: 'Коррекция зрения',
      services: [
        { name: 'Подбор очковой коррекции зрения', price: '700' },
        { name: 'Подбор контактной коррекции зрения', price: '1800' },
        { name: 'Подбор контактной коррекции зрения МКЛ "SAUFLON CLARITI 1day (30 шт.)', price: '2900' },
        { name: 'Подбор контактной коррекции зрения МКЛ "SAUFLON CLARITI 1day TORIC (30 шт.)', price: '3500' },
        { name: 'Подбор контактной коррекции зрения МКЛ "Biofiniti (3bl)', price: '3600' },
        { name: 'Подбор контактной коррекции зрения МКЛ "Biofiniti toric(3bl)', price: '4000' },
        { name: 'Подбор контактной коррекции зрения Раствор "Unica Avizor Sensitiv 350ml', price: '1000' },
        { name: 'Подбор контактной коррекции зрения МКЛ "Avaira Vitality (6bl)', price: '3700' },
        { name: 'Подбор контактной коррекции зрения МКЛ "Avaira Vitality toric (6bl)', price: '4000' }
      ]
    },
    {
      category: 'Физиотерапия и массаж',
      services: [
        { name: 'Массаж век медицинский', price: '1000' },
        { name: 'Низкочастотная магнитотерапия на орган зрения', price: '800' },
        { name: 'Электростимуляция зрительного нерва', price: '800' },
        { name: 'Электростимуляция цилиарного тела', price: '800' },
        { name: 'Рефлексотерапия при заболеваниях органа зрения', price: '2100' }
      ]
    },
    {
      category: 'Тренировки и упражнения',
      services: [
        { name: 'Упражнения для восстановления и укрепления бинокулярного зрения', price: '2400' },
        { name: 'Упражнения для восстановления и укрепления бинокулярного зрения на аппарате Синоптофор', price: '800' },
        { name: 'Упражнения для тренировки цилиарной мышцы', price: '2300' },
        { name: 'Лазерная стимуляция цилиарной мышцы', price: '1300' }
      ]
    }
  ];
