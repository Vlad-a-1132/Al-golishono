...
const anchorLinks = [
  ...
  { href: "#newborn", label: "Новорождённые" },
  { href: "#faq", label: "FAQ" },
  { href: "#address", label: "Адрес" },
];

const whyItems = [
  "Опытные врачи-педиатры",
  "Приём детей от рождения до 18 лет",
  "Справки в сад, школу, бассейн и спортсекцию",
  "Удобная запись и приём в Голицыно",
];

const symptoms = [
  "повышение температуры, простуда, кашель",
  "расстройство пищеварения, рвота, диарея",
  "сыпь на коже, аллергические реакции",
  "боль в животе, головная боль, вялость",
...
const helpsWith = [
  ...
  "диспансерный приём и расшифровка анализов",
  "справки в детский сад, школу, бассейн",
  "справки в спортивную секцию и для представления",
  "заключение о физическом развитии",
];

const newbornServices = [
  "обучение уходу за новорождённым",
  "пеленание новорождённого",
  "назначение препаратов при патологии у новорождённого",
];

const faqItems = [
  {
    q: "Когда нужно обращаться к педиатру?",
    a: "К педиатру обращаются при плановых осмотрах по возрасту, при повышении температуры выше 38°C, симптомах простуды, расстройстве пищеварения, сыпи, болях, вялости, нарушении сна и поведения, а также для оформления справок в сад, школу, бассейн, спортивную секцию.",
  },
  {
    q: "Какие справки оформляет педиатр?",
    a: "В «Альтамед Голицыно» педиатр оформляет справки в детский сад и школу, в бассейн по результатам обследования, в спортивную секцию (при наличии ЭКГ с расшифровкой), справки для представления и другие документы после осмотра ребёнка.",
  },
  {
    q: "Помощь новорождённым",
    a: "Мы оказываем услуги по обучению уходу за новорождённым, пеленанию, составлению заключения о физическом развитии, назначению лекарственных препаратов при патологии у новорождённого.",
  },
];
...
function Breadcrumbs() {
  return (
    <nav className="flex text-sm text-gray-500" aria-label="Breadcrumb">
      ...
      <span className="mx-2">/</span>
      <span className="text-gray-800">Педиатр</span>
    </nav>
  );
}
...
export default function PediatrGolitsinoClient({
  services,
  priceFrom,
}: Props) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-white">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold leading-tight text-gray-900 md:text-4xl">
              Педиатр в Голицыно — приём, справки и запись в «Альтамед Голицыно»
            </h1>
            <p className="mt-4 text-base leading-relaxed text-gray-600 md:text-lg">
              Медицинская помощь детям от рождения до 18 лет: приём педиатра,
              диспансерное наблюдение, справки в сад, школу, бассейн и
              спортивную секцию, уход за новорождёнными.
            </p>
      ...
      <section id="reasons" className="scroll-mt-24 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            С чем педиатр помогает разобраться
          </h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {helpsWith.map((item) => (
              <div
      ...
      <section id="newborn" className="scroll-mt-24 bg-gray-50 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            Помощь новорождённым
          </h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {newbornServices.map((item) => (
              <div
                key={item}
