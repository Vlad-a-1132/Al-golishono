            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2">УЗИ Голицино</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              УЗИ в клинике «<span className="italic">Альтамед Голицино</span>» в Голицино
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Полный спектр УЗИ-исследований в клинике «Альтамед Голицино» в Голицино
            </p>
          </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="mb-8">
            <p className="text-gray-700 mb-4 leading-relaxed">
              <strong>Ультразвуковое исследование (УЗИ)</strong> — это безопасный, безболезненный и высокоинформативный метод диагностики, использующий ультразвуковые волны для визуализации внутренних органов и тканей. В медицинском центре «Альтамед Голицино» в Голицино УЗИ выполняется на современном оборудовании экспертного класса, что обеспечивает высочайшую точность диагностики и качественные изображения.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Основные преимущества УЗИ в Голицино — полная безопасность (нет ионизирующего излучения), безболезненность процедуры, немедленное получение результатов, возможность многократного исследования, высокая информативность. В клинике «Альтамед Голицино» проводятся все виды ультразвуковой диагностики: УЗИ органов брюшной полости, УЗИ малого таза, УЗИ сосудов шеи и конечностей, УЗИ сердца (эхокардиография), УЗИ щитовидной железы, УЗИ молочных желез, УЗИ при беременности, УЗИ детям.
            </p>
            <div className="bg-gray-50 rounded-[20px] p-6 shadow-md border-l-4 border-[#2C83A7]">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Преимущества УЗИ в клинике «Альтамед Голицино» в Голицино:</h3>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <p className="text-gray-700 mb-6 text-center max-w-3xl mx-auto">
            В медицинском центре «Альтамед Голицино» в Голицино наиболее часто выполняются следующие виды ультразвуковой диагностики:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-blue-100">
              ...
              <p className="text-gray-600 leading-relaxed mb-3">
                УЗИ сосудов шеи (дуплексное сканирование брахиоцефальных артерий) — исследование сосудов, питающих головной мозг. Проводится при головных болях, головокружениях, для оценки риска инсульта. В клинике «Альтамед Голицино» выполняется с функциональными пробами и интракраниальным сегментом.
              </p>
              <div className="text-[#2C83A7] font-semibold text-lg">
                От 3900 ₽
              </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="bg-white rounded-[20px] p-8 shadow-lg border-l-4 border-[#2C83A7]">
            <p className="text-gray-700 mb-4 leading-relaxed">
              В медицинском центре «Альтамед Голицино» в Голицино УЗИ детям проводится с особой заботой и вниманием. Ультразвуковая диагностика абсолютно безопасна для детей любого возраста, включая новорожденных, и может проводиться многократно без вреда для здоровья.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <p className="text-gray-700 leading-relaxed">
              Врачи клиники «Альтамед Голицино» имеют большой опыт работы с детьми, создают комфортную и спокойную атмосферу, используют специальные протоколы исследования. УЗИ детям в Голицино — это безопасный, быстрый и информативный метод диагностики.
            </p>
          </div>
        </div>
      </section>
