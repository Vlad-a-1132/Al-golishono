...
const whyItems = [
  "Опытные врачи-урологи и детские урологи-андрологи",
  "Диагностика и лечение урологических заболеваний",
  "УЗИ, манипуляции, физиотерапия",
...
const symptoms = [
  ...
  "выделения, дискомфорт в области половых органов",
  "снижение потенции, бесплодие",
  "плановые осмотры и диспансеризация",
];

const helpsWith = [
  "диагностика заболеваний мочеполовой системы",
  "лечение простатита, цистита, пиелонефрита",
  "приём взрослого уролога и детского уролога-андролога",
  "катетеризация и инстилляция мочевого пузыря",
  "массаж простаты, сбор секрета простаты",
  "физиотерапия и назначение терапии",
];
...
const diagnostics = [
  ...
  "магнитотерапия и вибрационное воздействие",
];

const faqItems = [
  {
    q: "Как записаться к урологу в Голицыно?",
    a: "Записаться к урологу в «Альтамед Голицыно» можно на сайте reg.altamed-golitsino.ru или по телефону +7 (495) 989-64-80. Клиника находится в Голицыно на Советской улице, 58.",
  },
  {
    q: "Какие услуги оказывает уролог?",
    a: "В клинике проводятся приём и диспансерный приём врача-уролога и детского уролога-андролога, УЗИ надпочечников, катетеризация и инстилляция мочевого пузыря, сбор секрета простаты, массаж простаты, физиотерапия (магнитотерапия, вибрационное воздействие, ректальная гипертермия и др.) и другие услуги по прейскуранту.",
  },
  {
    q: "Принимает ли детский уролог?",
    a: "Да. В «Альтамед Голицыно» ведут приём врачи-урологи и детские урологи-андрологи. Запись на приём ребёнка — через онлайн-регистратуру или по телефону клиники.",
  },
];
...
function Breadcrumbs() {
  return (
    <nav className="flex text-sm text-gray-500" aria-label="Breadcrumb">
      ...
      <span className="mx-2">/</span>
      <span className="text-gray-800">Уролог</span>
    </nav>
  );
}
...
export default function UrologGolitsinoClient({
  services,
  priceFrom,
}: Props) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-white">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold leading-tight text-gray-900 md:text-4xl">
              Уролог в Голицыно — приём, диагностика и запись в «Альтамед
              Голицыно»
            </h1>
            <p className="mt-4 text-base leading-relaxed text-gray-600 md:text-lg">
              Приём врача-уролога и детского уролога-андролога, УЗИ
              надпочечников, манипуляции, массаж простаты, физиотерапия и другие
              услуги по прейскуранту клиники.
            </p>
      ...
      <section id="reasons" className="scroll-mt-24 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            С чем уролог помогает разобраться
          </h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {helpsWith.map((item) => (
              <div
