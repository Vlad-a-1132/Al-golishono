...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://altamed-golitsino.ru/services/urolog-golitsino',
  ...
  alternates: { canonical: 'https://altamed-golitsino.ru/services/urolog-golitsino' },
};

export default function UrologGolitsinoLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
