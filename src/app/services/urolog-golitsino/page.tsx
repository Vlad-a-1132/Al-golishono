...
const faqUrolog = [
  { q: 'Как записаться к урологу в Голицино?', a: 'Записаться к урологу в «Альтамед Голицино» можно на сайте reg.altamed-golitsino.ru или по телефону +7 (495) 989-64-80. Клиника находится в Голицыно на Советской улице, 58.' },
  { q: 'Какие услуги оказывает уролог в Альтамед Голицино?', a: 'В «Альтамед Голицино» проводятся приём и диспансерный приём врача-уролога и детского уролога-андролога, УЗИ надпочечников, катетеризация и инстилляция мочевого пузыря, сбор секрета простаты, массаж простаты, физиотерапия (магнитотерапия, вибрационное воздействие, ректальная гипертермия и др.), назначение лекарственной терапии. Стоимость уточняйте при записи.' },
  { q: 'Принимает ли детский уролог в Голицино?', a: 'Да. В «Альтамед Голицино» ведут приём врачи-урологи и детские урологи-андрологи. Запись на приём ребёнка — на сайте или по телефону клиники.' },
  { q: 'Где находится уролог в Голицино?', a: 'Уролог ведёт приём в медицинском центре «Альтамед Голицино» по адресу: Московская область, Одинцовский городской округ, Голицыно, Советская улица, 58. Добраться можно на электричке до станции Голицыно или на автобусах до остановки «Девятки».' },
];
...
export default function UrologGolitsinoPage() {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
      ...
      {/* Урология в Голицино — SEO-текст */}
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Урология в Голицино</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Уролог в Голицино — специалист по диагностике и лечению заболеваний мочевыводящих путей, почек, мочевого пузыря и мужской половой системы. В медицинском центре «Альтамед Голицино» ведут приём врачи-урологи и детские урологи-андрологи: первичный и диспансерный приём, УЗИ надпочечников, катетеризация и инстилляция мочевого пузыря, сбор секрета простаты, массаж простаты, физиотерапия и другие услуги по прейскуранту.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Записаться к урологу в Голицино можно онлайн на сайте или по телефону. Клиника «Альтамед Голицино» находится по адресу: Голицыно, Советская улица, 58. Урология для взрослых и детей — жителям Голицино и Одинцовского городского округа Московской области.
          </p>
          <p className="text-gray-600 leading-relaxed">
            К урологу обращаются при проблемах с мочеиспусканием, болях в области почек и мочевого пузыря, при цистите, простатите, мочекаменной болезни, нарушениях половой функции, а также для профилактических осмотров. Детский уролог-андролог в Голицино принимает детей с врождёнными и приобретёнными заболеваниями мочеполовой системы.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white" aria-labelledby="what-we-treat-heading">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="space-y-6 text-gray-700 mb-8">
            ...
            <p>
              Уролог в Голицино занимается лечением цистита, пиелонефрита, мочекаменной болезни, простатита, аденомы предстательной железы, уретрита, заболеваний почек и мочеточников, мужского бесплодия и эректильной дисфункции, детских урологических заболеваний. Ниже — список заболеваний и состояний, с которыми можно обратиться к урологу в «Альтамед Голицино».
            </p>
          </div>
      ...
      {/* Когда обращаться к урологу в Голицино — SEO-подзаголовок */}
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Когда обращаться к урологу в Голицино</h2>
          <p className="text-gray-600 mb-6 leading-relaxed max-w-3xl">
            К врачу-урологу в «Альтамед Голицино» стоит записаться при появлении любых из перечисленных ниже симптомов или ситуаций. Не откладывайте визит: чем раньше проведена диагностика, тем эффективнее лечение. Запись к урологу в Голицино — на сайте или по телефону клиники.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 bg-white" aria-labelledby="faq-heading">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 id="faq-heading" className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Часто задаваемые вопросы — уролог в Голицино</h2>
