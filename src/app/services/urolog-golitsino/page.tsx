...
const faqUrolog = [
  { q: 'Как записаться к урологу в Голицыно?', a: 'Записаться к урологу в «Альтамед Голицыно» можно на сайте reg.altamed-golitsino.ru или по телефону +7 (495) 989-64-80. Клиника находится в Голицыно на Советской улице, 58.' },
  { q: 'Какие услуги оказывает уролог в Альтамед Голицыно?', a: 'В «Альтамед Голицыно» проводятся приём и диспансерный приём врача-уролога и детского уролога-андролога, УЗИ надпочечников, катетеризация и инстилляция мочевого пузыря, сбор секрета простаты, массаж простаты, физиотерапия (магнитотерапия, вибрационное воздействие, ректальная гипертермия и др.), назначение лекарственной терапии. Стоимость уточняйте при записи.' },
  { q: 'Принимает ли детский уролог в Голицыно?', a: 'Да. В «Альтамед Голицыно» ведут приём врачи-урологи и детские урологи-андрологи. Запись на приём ребёнка — на сайте или по телефону клиники.' },
  { q: 'Где находится уролог в Голицыно?', a: 'Уролог ведёт приём в медицинском центре «Альтамед Голицыно» по адресу: Московская область, Одинцовский городской округ, Голицыно, Советская улица, 58. Добраться можно на электричке до станции Голицыно или на автобусах до остановки «Девятки».' },
];

export default function UrologGolitsinoPage() {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
      ...
      {/* Урология в Голицыно — SEO-текст */}
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Урология в Голицыно</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Уролог в Голицыно — специалист по диагностике и лечению заболеваний мочевыводящих путей, почек, мочевого пузыря и мужской половой системы. В медицинском центре «Альтамед Голицыно» ведут приём врачи-урологи и детские урологи-андрологи: первичный и диспансерный приём, УЗИ надпочечников, катетеризация и инстилляция мочевого пузыря, сбор секрета простаты, массаж простаты, физиотерапия и другие услуги по прейскуранту.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Записаться к урологу в Голицыно можно онлайн на сайте или по телефону. Клиника «Альтамед Голицыно» находится по адресу: Голицыно, Советская улица, 58. Урология для взрослых и детей — жителям Голицыно и Одинцовского городского округа Московской области.
          </p>
          <p className="text-gray-600 leading-relaxed">
            К урологу обращаются при проблемах с мочеиспусканием, болях в области почек и мочевого пузыря, при цистите, простатите, мочекаменной болезни, нарушениях половой функции, а также для профилактических осмотров. Детский уролог-андролог в Голицыно принимает детей с врождёнными и приобретёнными заболеваниями мочеполовой системы.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white" aria-labelledby="what-we-treat-heading">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="space-y-6 text-gray-700 mb-8">
            ...
            <p>
              Уролог в Голицыно занимается лечением цистита, пиелонефрита, мочекаменной болезни, простатита, аденомы предстательной железы, уретрита, заболеваний почек и мочеточников, мужского бесплодия и эректильной дисфункции, детских урологических заболеваний. Ниже — список заболеваний и состояний, с которыми можно обратиться к урологу в «Альтамед Голицыно».
            </p>
          </div>
      ...
      {/* Когда обращаться к урологу в Голицыно — SEO-подзаголовок */}
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Когда обращаться к урологу в Голицыно</h2>
          <p className="text-gray-600 mb-6 leading-relaxed max-w-3xl">
            К врачу-урологу в «Альтамед Голицыно» стоит записаться при появлении любых из перечисленных ниже симптомов или ситуаций. Не откладывайте визит: чем раньше проведена диагностика, тем эффективнее лечение. Запись к урологу в Голицыно — на сайте или по телефону клиники.
          </p>
        </div>
      </section>

      {/* Поводы обращения к врачу-урологу — оформленный блок */}
      <section className="py-16 md:py-20 bg-gradient-to-b from-emerald-50/80 to-white" aria-labelledby="reasons-heading">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row lg:items-start lg:gap-12">
            <div className="flex-1 order-2 lg:order-1">
              <h2 id="reasons-heading" className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-start gap-3 p-4 rounded-xl bg-white border border-emerald-100/80 shadow-sm hover:shadow-md hover:border-emerald-200 transition-all duration-200"
                  >
                    <span className="flex-shrink-0 w-7 h-7 rounded-full bg-emerald-500 text-white flex items-center justify-center text-sm font-semibold">
                      {i + 1}
                    </span>
                    <span className="text-gray-700 text-sm md:text-base leading-snug pt-0.5">{text}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="flex-shrink-0 order-1 lg:order-2 mb-8 lg:mb-0 lg:sticky lg:top-8">
              <div className="w-40 h-40 md:w-52 md:h-52 lg:w-56 lg:h-56 mx-auto lg:mx-0 rounded-full overflow-hidden ring-4 ring-white shadow-xl border border-gray-100">
                <img
                  src="/images/yslugi/yrolog.webp"
                  alt="Врач-уролог"
      ...
      <section className="py-12 bg-white" aria-labelledby="faq-heading">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 id="faq-heading" className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Часто задаваемые вопросы — уролог в Голицыно</h2>
          <div className="space-y-1">
            {faqUrolog.map((item, index) => (
              <div key={index} className="border-b border-gray-200">
                <button
                  type="button"
                  onClick={() => setFaqExpanded(faqExpanded === index ? null : index)}
                  className="flex items-center justify-between w-full text-left py-4 pr-2"
                >
                  <h3 className="text-lg font-semibold text-gray-900 pr-4">{item.q}</h3>
                  <span className={`text-2xl text-emerald-600 flex-shrink-0 transition-transform ${faqExpanded === index ? 'rotate-45' : ''}`}>+</span>
                </button>
                {faqExpanded === index && (
                  <div className="pb-4">
