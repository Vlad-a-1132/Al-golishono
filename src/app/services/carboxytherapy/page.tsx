    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="pt-4 md:pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h1 className="text-2xl md:text-4xl font-bold text-black">Карбокситерапия в Голицыно — лечение в медицинском центре Альтамед Голицыно</h1>
        </div>
      </section>
            ...
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-1/2 p-6 md:p-8 text-white">
                <p className="mb-4">
                  ...
                  чистого углекислого медицинского газа. В медицинском центре Альтамед Голицыно эта процедура проводится опытными специалистами с использованием современного оборудования.
                </p>
                <p className="mb-4">
              ...
              <div className="w-full md:w-1/2 relative h-[240px] md:h-auto">
                <Image
                  ...
                  alt="Карбокситерапия в Альтамед Голицыно"
                  fill
      ...
      <section className="py-4">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Преимущества карбокситерапии в Альтамед Голицыно</h2>
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-[20px] p-6">
                ...
                <p className="text-gray-700 mt-4">
                  Карбокситерапия в Альтамед Голицыно эффективна при лечении хронических болей, воспалительных процессов и нарушений кровообращения. Процедура назначается после консультации с врачом.
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="bg-gray-50 rounded-[20px] p-6">
                ...
                <p className="text-gray-700 mt-4">
                  Метод также применяется для решения косметологических задач и улучшения качества кожи. В медицинском центре Альтамед Голицыно карбокситерапия используется как самостоятельный метод лечения, так и в составе комплексной терапии.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="space-y-4 text-gray-700">
            <p className="text-base md:text-lg">
              Карбокситерапия основана на введении медицинского углекислого газа (CO2) в ткани организма. В медицинском центре Альтамед Голицыно процедура выполняется с помощью специального аппарата, который обеспечивает точную дозировку и контроль процесса.
            </p>
            <p className="text-base md:text-lg">
      ...
      <section className="py-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h3 className="text-2xl font-bold mb-4">Подготовка к проведению процедуры в Альтамед Голицыно</h3>
          <div className="text-gray-800 space-y-4">
            <p>
              На консультации врач медицинского центра Альтамед Голицыно оценивает возможность проведения карбокситерапии и исключает противопоказания (беременность и ГВ, обострения хронических заболеваний и др.). Специалист определяет показания к процедуре и составляет индивидуальный план лечения.
            </p>
            <p>
            ...
            <p>
              Процедура проводится в комфортных условиях медицинского центра Альтамед Голицыно. Длительность сеанса составляет от 15 до 30 минут в зависимости от области воздействия. После процедуры можно сразу вернуться к обычной деятельности.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-sm md:text-base text-gray-700 mb-4">
            ...
            администратора клиники Альтамед Голицыно.
          </p>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="space-y-4 text-gray-700">
            <p className="text-base md:text-lg">
              В медицинском центре Альтамед Голицыно курс карбокситерапии подбирается индивидуально для каждого пациента. Обычно для достижения стойкого эффекта требуется от 5 до 10 процедур с интервалом 3-7 дней.
            </p>
            <p className="text-base md:text-lg">
              Первые результаты лечения могут быть заметны уже после 2-3 процедур. Для поддержания эффекта рекомендуется проходить профилактические курсы 1-2 раза в год. Специалисты Альтамед Голицыно разрабатывают индивидуальную программу лечения с учетом особенностей каждого пациента.
            </p>
            <p className="text-base md:text-lg">
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Почему выбирают карбокситерапию в Альтамед Голицыно</h2>
