...
const whyItems = [
  ...
  "Проверка зрения и подбор очков и линз",
  "Современная диагностика глаз",
...
const helpsWith = [
  ...
  "приём и консультация (в том числе с расширением зрачка)",
  "подбор очковой и контактной коррекции",
  "офтальмоскопия, тонометрия, авторефрактометрия",
  "удаление инородных тел, промывание конъюнктивы",
  "наблюдение при глаукоме, катаракте, диабетической ретинопатии",
];

const diagnostics = [
  "биомикроскопия и офтальмоскопия",
  "офтальмотонометрия и тонография",
  "авторефрактометрия",
  "определение рефракции и скиаскопия",
  "исследование цветоощущения и тест Ширмера",
];

const faqItems = [
  {
    q: "Когда обращаться к офтальмологу?",
    a: "К офтальмологу обращаются при снижении зрения, болях и рези в глазах, слезотечении, сухости, покраснении, для подбора очков или контактных линз, при попадании инородного тела, а также для профилактического осмотра и наблюдения при глаукоме, катаракте, диабетической ретинопатии.",
  },
  {
    q: "Какие услуги оказывает офтальмолог?",
    a: "В «Альтамед Голицыно» проводятся приём и консультация офтальмолога (в том числе с расширением зрачка), офтальмоскопия, тонометрия, авторефрактометрия, подбор очковой и контактной коррекции, биомикроскопия, удаление инородных тел, промывание конъюнктивальной полости и другие процедуры по прейскуранту.",
  },
  {
    q: "Есть ли подбор очков и линз?",
    a: "Да. Выполняется подбор очковой коррекции (простых и сложных очков для близи и дали), подбор контактной коррекции и подбор контактной коррекции с обучением. Запись — через онлайн-регистратуру или по телефону клиники.",
  },
];
...
function Breadcrumbs() {
  return (
    <nav className="flex text-sm text-gray-500" aria-label="Breadcrumb">
      ...
      <span className="mx-2">/</span>
      <span className="text-gray-800">Офтальмолог</span>
    </nav>
  );
}
...
export default function OftalmologGolitsinoClient({
  services,
  priceFrom,
}: Props) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-white">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold leading-tight text-gray-900 md:text-4xl">
              Офтальмолог в Голицыно — приём, диагностика и запись в «Альтамед
              Голицыно»
            </h1>
            <p className="mt-4 text-base leading-relaxed text-gray-600 md:text-lg">
              Проверка зрения, подбор очков и контактных линз, диагностика и
              лечение заболеваний глаз. Приём, тонометрия, биомикроскопия и
      ...
      <section id="reasons" className="scroll-mt-24 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            С чем офтальмолог помогает разобраться
          </h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {helpsWith.map((item) => (
              <div
