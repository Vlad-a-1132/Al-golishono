    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            У детей дошкольного и школьного возраста остеопаты центра Альтамед-С помогают справиться с трудностями обучения: недостаточность внимания, гиперактивность, утомляемость. Часто проблемы с обучением связаны не с интеллектом, а с нарушением работы глазных мышц и зрения. Чем раньше показать ребенка остеопату в Одинцово, тем эффективнее будет коррекция.
          </p>
        </div>
      </section>
