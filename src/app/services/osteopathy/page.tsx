    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="pt-4 md:pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h1 className="text-2xl md:text-4xl font-bold text-black">Остеопатия в Голицино — лечение в медицинском центре Альтамед Голицино</h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <div className="w-full md:w-1/2">
              <div className="relative w-full aspect-square max-w-md mx-auto rounded-full overflow-hidden">
                <Image
                  ...
                  alt="Остеопатия в Альтамед Голицино"
                  fill
            ...
            <div className="w-full md:w-1/2 text-gray-700 space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-black">Лечение у остеопата в Голицино</h2>
              <p>
                В медицинском центре Альтамед Голицино опытные врачи-остеопаты помогают восстановить баланс организма и справиться с функциональными нарушениями. Организм человека — это уникальная саморегулирующаяся система, способная поддерживать здоровье и противостоять болезням. Однако современные факторы окружающей среды часто нарушают этот баланс, приводя к различным патологическим состояниям.
              </p>
              <p>
                Остеопаты центра Альтамед Голицино направляют свои усилия на поиск истинных причин нарушений и восстановление естественного равновесия в организме пациента. Наши специалисты используют мягкие мануальные техники, которые активируют собственные ресурсы организма для самовосстановления.
              </p>
              <p>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">
            Когда стоит обратиться к остеопату в Голицино
          </h2>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            В теле все ткани и органы находятся в строго определенном, эволюционно заложенном движении относительно друг друга. По каким-то причинам возникает нарушение подвижности в теле, фиксация, а это приводит к поражению структуры. Остеопаты медицинского центра Альтамед Голицино выявляют эти нарушения с помощью специальных диагностических техник.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Остеопатия — мануальная медицина. Остеопатическая диагностика мануальная, т. е. пальпация особо чувствительными руками. Врачи Альтамед Голицино проходят специальную подготовку для развития тактильной чувствительности, позволяющей выявлять малейшие нарушения в тканях.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Диагностические остеопатические тесты — тесты на подвижность ткани или органа, если подвижности нет, значит нарушена структура. Специалисты центра Альтамед Голицино используют эти тесты для точной диагностики и выбора оптимальной тактики лечения.
          </p>
        </div>
      </section>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Остеопатическое лечение в Голицино</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Остеопатическое лечение в медицинском центре Альтамед Голицино направлено на восстановление ограниченной подвижности. В отличие от мануальной терапии, которая фокусируется на локальных проблемах, остеопат проводит комплексный осмотр всего тела, чтобы выявить первопричину заболевания. Это позволяет достичь более глубокого и стойкого результата.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Главное преимущество остеопатии — практически полное отсутствие противопоказаний. Метод эффективен даже у пациентов с онкологическими заболеваниями, помогая уменьшить страдания и улучшить качество жизни. В Альтамед Голицино остеопатическое лечение применяется у пациентов всех возрастов — от новорожденных до пожилых людей.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Особенно эффективна остеопатия в лечении новорожденных в Голицино: родовые травмы, ДЦП, гипервозбудимость, срыгивание, рвота и другие нарушения успешно корректируются нашими специалистами. Детские остеопаты Альтамед Голицино имеют специальную подготовку для работы с маленькими пациентами.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            У детей дошкольного и школьного возраста остеопаты центра Альтамед Голицино помогают справиться с трудностями обучения: недостаточность внимания, гиперактивность, утомляемость. Часто проблемы с обучением связаны не с интеллектом, а с нарушением работы глазных мышц и зрения. Чем раньше показать ребенка остеопату в Голицино, тем эффективнее будет коррекция.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Что делает врач-остеопат на приеме в Альтамед Голицино</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            На консультации в медицинском центре Альтамед Голицино врач-остеопат проводит комплексную мануальную диагностику, коррекцию позвоночника, краниальную терапию, висцеральную мануальную терапию и мышечную релаксацию при следующих заболеваниях:
          </p>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Преимущества остеопатии в Альтамед Голицино</h2>
