...
export const metadata: Metadata = {
  ...
  description: 'Гастроэнтеролог в Одинцово - профессиональная диагностика и лечение заболеваний ЖКТ. Гастроскопия, колоноскопия, УЗИ. Запись на прием к гастроэнтерологу в клинике Альтамед-СОдинцово.',
  keywords: [
