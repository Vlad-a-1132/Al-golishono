...
export const metadata: Metadata = {
  ...
  description: 'Гастроэнтеролог в Одинцово - профессиональная диагностика и лечение заболеваний ЖКТ. Гастроскопия, колоноскопия, УЗИ. Запись на прием к гастроэнтерологу в клинике Альтамед-с Одинцово.',
  keywords: [
  ...
  other: {
    'application/ld+json': JSON.stringify({
      ...
      "description": "Клиника гастроэнтерологии в Одинцово. Профессиональная диагностика и лечение заболеваний ЖКТ. Гастроскопия, колоноскопия, УЗИ брюшной полости.",
      "url": "https://altamed-s.ru/services/gastroenterology",
