...
const whyItems = [
  ...
  "Школы для больных (рассеянный склероз, эпилепсия, Паркинсон)",
  "Реабилитация после инсульта и ЧМТ, блокады нервов",
  "Ортопедические стельки ФормТотикс в Голицыно",
];
...
const helpsWith = [
  ...
  "блокады периферических нервов при боли",
  "школы для пациентов (РС, эпилепсия, Паркинсон и др.)",
  "подбор ортопедических стелек ФормТотикс",
  "диспансерное наблюдение и план лечения",
];

const diagnostics = [
  "неврологический осмотр и консультация",
  "назначение обследований (МРТ, УЗИ, анализы — по показаниям)",
  "блокады периферических нервов",
  "медицинская реабилитация",
  "обучение в школах для больных (по программе)",
];

const faqItems = [
  {
    q: "Когда обращаться к неврологу?",
    a: "К неврологу обращаются при головных болях, головокружении, болях в спине и шее, онемении конечностей, нарушениях сна и памяти, при рассеянном склерозе, эпилепсии, болезни Паркинсона, а также для реабилитации после инсульта и черепно-мозговой травмы.",
  },
  {
    q: "Какие услуги оказывает невролог в «Альтамед Голицыно»?",
    a: "В клинике проводятся приём и диспансерный приём врача-невролога, школы для больных (рассеянный склероз, эпилепсия, Паркинсон, суставы и позвоночник), реабилитация после инсульта и ЧМТ, блокады периферических нервов, ортопедические стельки ФормТотикс по прейскуранту.",
  },
  {
    q: "Что такое блокада нерва?",
    a: "Блокада — введение препарата в область нерва для снятия боли. В прайсе указаны разные виды блокад (карпальный канал, грушевидная мышца, паравертебральная и др.). Врач подберёт метод по показаниям.",
  },
];
...
function Breadcrumbs() {
  return (
    <nav className="flex text-sm text-gray-500" aria-label="Breadcrumb">
      ...
      <span className="mx-2">/</span>
      <span className="text-gray-800">Неврология</span>
    </nav>
  );
}
...
export default function NevrologGolitsinoClient({
  services,
  priceFrom,
}: Props) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-white">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold leading-tight text-gray-900 md:text-4xl">
              Невролог в Голицыно — приём, диагностика и запись в «Альтамед
              Голицыно»
            </h1>
            <p className="mt-4 text-base leading-relaxed text-gray-600 md:text-lg">
              Приём врача-невролога, школы для больных, реабилитация после
              инсульта и черепно-мозговой травмы, блокады периферических нервов,
      ...
      <section id="reasons" className="scroll-mt-24 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            С чем невролог помогает разобраться
          </h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {helpsWith.map((item) => (
              <div
