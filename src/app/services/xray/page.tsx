...
export default function XRayPage() {
  ...
  const faqItems = [
    ...
    {
      question: "Что такое рентген с контрастом в Одинцово?",
      answer: "Рентгенография с контрастом используется для детального исследования органов ЖКТ и мочевыделительной системы. Контрастное вещество вводится в организм и значительно улучшает визуализацию внутренних структур. В клинике «Альтамед-С» используются современные безопасные контрастные препараты. Рентген с контрастом назначается только по строгим показаниям."
    },
    {
