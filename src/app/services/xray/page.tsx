...
export default function XRayPage() {
  ...
  const faqItems = [
    {
      question: "Как часто можно делать рентген в Голицыно?",
      answer: "Частота рентгеновских исследований в клинике «Альтамед Голицыно» определяется врачом индивидуально, в зависимости от показаний. Современная цифровая аппаратура использует минимальные дозы облучения, безопасные для здоровья. Лучевая нагрузка на цифровых рентген-аппаратах в 2-3 раза ниже, чем на пленочных."
    },
    {
      question: "Вреден ли рентген для детей в Голицыно?",
      answer: "При соблюдении всех мер защиты рентген полностью безопасен для детей. В медицинском центре «Альтамед Голицыно» используется современное оборудование с минимальной дозой облучения. Для детей применяются специальные протоколы с еще меньшими дозами излучения. Исследование назначается только по строгим медицинским показаниям."
    },
    {
      question: "Нужна ли подготовка к рентгену в Голицыно?",
      answer: "Большинство рентгеновских исследований в клинике «Альтамед Голицыно» не требуют специальной подготовки. Рентген легких, костей, суставов, позвоночника, зубов проводится без подготовки. Исключение составляют рентген желудка и кишечника, которые требуют диеты и очищения кишечника. Подробную информацию о подготовке вы получите при записи на исследование."
    },
    {
      question: "Сколько стоит сделать рентген в Голицыно?",
      answer: "Стоимость рентгенографии в клинике «Альтамед Голицыно» зависит от типа исследования. Цены начинаются от 2000 рублей за рентген отдельных костей и суставов. Рентген легких стоит от 2500 рублей, рентген позвоночника — от 2900 рублей. Уточнить точную стоимость конкретного исследования вы можете при записи или по телефону клиники."
    },
    {
      question: "Где можно сделать рентген в Голицыно платно?",
      answer: "Медицинский центр «Альтамед Голицыно» в Голицыно предлагает платные рентгенологические исследования на современном цифровом оборудовании. Клиника находится в центре Голицыно, работает ежедневно. Записаться на рентген можно по телефону или через форму записи на сайте. При необходимости возможно проведение рентгена в день обращения."
    }
  ];
  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              Рентген в клинике «<span className="italic">Альтамед Голицыно</span>» в Голицыно
            </h1>
            <p className="text-gray-600 mt-2 px-4 md:px-0 text-sm md:text-base">
              Современная цифровая рентгенография в Голицыно: диагностика заболеваний и травм
            </p>
          </header>
          ...
          <div className="mb-8">
              ...
              <div className="h-[220px] bg-[#4A5568] relative overflow-hidden">
                <div className="w-full h-full relative">
                  <img
                    ...
                    alt="Рентген в Голицыно"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
              <div className="bg-white p-4 flex flex-col justify-between items-start gap-3">
                <div className="text-black font-medium text-sm">Рентгенография в Голицыно</div>
                <Link 
            ...
            <div className="hidden md:block h-[445px] bg-[#4A5568] relative overflow-hidden rounded-[20px] shadow-lg">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-start p-8 md:p-12 text-black">
                <h2 className="text-2xl md:text-4xl font-bold mb-4">Рентген в Голицыно</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Полный спектр рентгенологических исследований в клинике «Альтамед Голицыно» в Голицыно
            </p>
          </div>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Рентген в Голицыно: современная цифровая диагностика</h2>
          <div className="mb-8">
            <p className="text-gray-700 mb-4 leading-relaxed">
              <strong>Рентгенография</strong> — один из самых востребованных и надежных методов лучевой диагностики. В медицинском центре «Альтамед Голицыно» в Голицыно рентгенологические исследования проводятся на современном цифровом оборудовании экспертного класса, которое обеспечивает высокое качество изображений при минимальной лучевой нагрузке.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Цифровая рентгенография в Голицыно используется для диагностики широкого спектра заболеваний: травм костей и суставов, заболеваний легких, патологий позвоночника, стоматологических проблем. Преимущества цифрового рентгена в клинике «Альтамед Голицыно» — высокая четкость изображений, возможность увеличения и обработки снимков, а также максимально низкая доза облучения.
            </p>
            <div className="bg-gray-50 rounded-[20px] p-6 shadow-md border-l-4 border-[#4A5568]">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Преимущества цифрового рентгена в Голицыно:</h3>
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start">
                  ...
                  <span>Доступные цены — демократичная стоимость рентгенографии в Голицыно</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Показания к рентгенографии в Голицыно</h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Популярные рентгенологические исследования в Голицыно</h2>
          <p className="text-gray-700 mb-6 text-center max-w-3xl mx-auto">
            В медицинском центре «Альтамед Голицыно» в Голицыно наиболее часто выполняются следующие виды рентгенографии:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Рентген легких в Голицыно</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
                Рентгенография легких — обязательное исследование при подозрении на пневмонию, туберкулез, новообразования. В клинике «Альтамед Голицыно» рентген легких проводится на цифровом оборудовании с минимальной лучевой нагрузкой.
              </p>
              <div className="text-[#4A5568] font-semibold text-lg">
                От 2500 ₽
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Рентген пазух носа в Голицыно</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Рентген позвоночника в Голицыно</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
                Рентгенография позвоночника применяется для диагностики остеохондроза, сколиоза, травм, межпозвонковых грыж. В клинике «Альтамед Голицыно» проводятся рентген всех отделов позвоночника, в том числе с функциональными пробами.
              </p>
              <div className="text-[#4A5568] font-semibold text-lg">
                От 2900 ₽
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Рентген коленного сустава в Голицыно</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Рентген тазобедренных суставов в Голицыно</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Рентген стопы в Голицыно</h3>
              <p className="text-gray-600 leading-relaxed mb-3">
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Рентген детям в Голицыно</h2>
          <div className="bg-white rounded-[20px] p-8 shadow-lg border-l-4 border-[#4A5568]">
            <p className="text-gray-700 mb-4 leading-relaxed">
              В медицинском центре «Альтамед Голицыно» в Голицыно рентгенологические исследования для детей проводятся с особым вниманием к безопасности. Современное цифровое оборудование позволяет использовать минимальные дозы излучения, безопасные для детского организма.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <p className="text-gray-700 leading-relaxed">
              Чаще всего детям в Голицыно назначаются: рентген грудной клетки при пневмонии, рентген пазух носа при подозрении на гайморит, рентген тазобедренных суставов для диагностики дисплазии, рентген костей и суставов при травмах.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Часто задаваемые вопросы о рентгене в Голицыно</h2>
