  ...
  const faqItems = [
    {
      ...
      answer: "Частота рентгеновских исследований в клинике «Альтамед Голицино» определяется врачом индивидуально, в зависимости от показаний. Современная цифровая аппаратура использует минимальные дозы облучения, безопасные для здоровья. Лучевая нагрузка на цифровых рентген-аппаратах в 2-3 раза ниже, чем на пленочных."
    },
    {
      question: "Вреден ли рентген для детей в Голицино?",
      answer: "При соблюдении всех мер защиты рентген полностью безопасен для детей. В медицинском центре «Альтамед Голицино» используется современное оборудование с минимальной дозой облучения. Для детей применяются специальные протоколы с еще меньшими дозами излучения. Исследование назначается только по строгим медицинским показаниям."
    },
    {
      question: "Нужна ли подготовка к рентгену в Голицино?",
      answer: "Большинство рентгеновских исследований в клинике «Альтамед Голицино» не требуют специальной подготовки. Рентген легких, костей, суставов, позвоночника, зубов проводится без подготовки. Исключение составляют рентген желудка и кишечника, которые требуют диеты и очищения кишечника. Подробную информацию о подготовке вы получите при записи на исследование."
    },
    {
      question: "Сколько стоит сделать рентген в Голицино?",
      answer: "Стоимость рентгенографии в клинике «Альтамед Голицино» зависит от типа исследования. Цены начинаются от 2000 рублей за рентген отдельных костей и суставов. Рентген легких стоит от 2500 рублей, рентген позвоночника — от 2900 рублей. Уточнить точную стоимость конкретного исследования вы можете при записи или по телефону клиники."
    },
    {
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              Рентген в клинике «<span className="italic">Альтамед Голицино</span>» в Голицино
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Полный спектр рентгенологических исследований в клинике «Альтамед Голицино» в Голицино
            </p>
          </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="mb-8">
            <p className="text-gray-700 mb-4 leading-relaxed">
              <strong>Рентгенография</strong> — один из самых востребованных и надежных методов лучевой диагностики. В медицинском центре «Альтамед Голицино» в Голицино рентгенологические исследования проводятся на современном цифровом оборудовании экспертного класса, которое обеспечивает высокое качество изображений при минимальной лучевой нагрузке.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Цифровая рентгенография в Голицино используется для диагностики широкого спектра заболеваний: травм костей и суставов, заболеваний легких, патологий позвоночника, стоматологических проблем. Преимущества цифрового рентгена в клинике «Альтамед Голицино» — высокая четкость изображений, возможность увеличения и обработки снимков, а также максимально низкая доза облучения.
            </p>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <p className="text-gray-700 mb-6 text-center max-w-3xl mx-auto">
            В медицинском центре «Альтамед Голицино» в Голицино наиболее часто выполняются следующие виды рентгенографии:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed mb-3">
                Рентгенография легких — обязательное исследование при подозрении на пневмонию, туберкулез, новообразования. В клинике «Альтамед Голицино» рентген легких проводится на цифровом оборудовании с минимальной лучевой нагрузкой.
              </p>
              <div className="text-[#4A5568] font-semibold text-lg">
                От 2500 ₽
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-[20px] shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed mb-3">
                Рентгенография позвоночника применяется для диагностики остеохондроза, сколиоза, травм, межпозвонковых грыж. В клинике «Альтамед Голицино» проводятся рентген всех отделов позвоночника, в том числе с функциональными пробами.
              </p>
              <div className="text-[#4A5568] font-semibold text-lg">
                От 2900 ₽
              </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="bg-white rounded-[20px] p-8 shadow-lg border-l-4 border-[#4A5568]">
            <p className="text-gray-700 mb-4 leading-relaxed">
              В медицинском центре «Альтамед Голицино» в Голицино рентгенологические исследования для детей проводятся с особым вниманием к безопасности. Современное цифровое оборудование позволяет использовать минимальные дозы излучения, безопасные для детского организма.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
