...
const faqItems = [
  {
    q: "Когда обращаться к гастроэнтерологу?",
    a: "К гастроэнтерологу обращаются при болях в животе, изжоге, тошноте, нарушении стула, вздутии, тяжести после еды, отрыжке, снижении аппетита, а также для планового наблюдения при хронических заболеваниях желудочно-кишечного тракта, печени и поджелудочной железы.",
  },
  {
    q: "Чем занимается гастроэнтеролог?",
    a: "Гастроэнтеролог диагностирует и лечит заболевания пищевода, желудка, кишечника, печени, желчевыводящих путей и поджелудочной железы. На приёме врач собирает жалобы, проводит осмотр, при необходимости назначает анализы и инструментальные исследования (УЗИ, ФГДС и др.).",
  },
  {
    q: "Есть ли детский гастроэнтеролог?",
    a: "В «Альтамед Голицыно» предусмотрен приём детского врача гастроэнтеролога. Записаться можно через форму на сайте, онлайн-регистратуру или по телефону клиники.",
  },
];
...
export default function GastroenterologGolitsinoClient({
  services,
  priceFrom,
}: Props) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-white">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold leading-tight text-gray-900 md:text-4xl">
              Гастроэнтеролог в Голицыно — приём, диагностика и запись в «Альтамед
              Голицыно»
            </h1>
            <p className="mt-4 text-base leading-relaxed text-gray-600 md:text-lg">
              Помогаем разобраться с симптомами со стороны желудка и кишечника,
              подобрать план обследований и тактику наблюдения. Врач на приёме
              уточняет жалобы, питание, образ жизни и перенесённые заболевания.
            </p>
          ...
          <div className="relative h-[260px] overflow-hidden rounded-2xl shadow-lg md:h-[360px]">
            <Image
              ...
              alt="Гастроэнтеролог в Голицыно"
              fill
      ...
      <section id="reasons" className="scroll-mt-24 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            С чем гастроэнтеролог помогает разобраться
          </h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {helpsWith.map((item) => (
              <div
        ...
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_300px]">
            <div>
              ...
              <div className="mb-10 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-2">
      ...
      {/* Адрес — те же контакты, что на сайте */}
