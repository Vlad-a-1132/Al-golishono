...
const faqItems = [
  ...
  { q: "Какие услуги оказывает психиатр и психолог в Альтамед Голицино?", a: "В «Альтамед Голицино» проводятся приём (осмотр, консультация) врача-психиатра и приём (осмотр, консультация) врача психолога. Стоимость уточняйте при записи." },
  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
        ...
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              Психиатр и психолог в Голицино — приём в «Альтамед Голицино»
            </h1>
            <p className="text-gray-600 mt-2 px-4 md:px-0 text-sm md:text-base">
              Консультация психиатра и психолога в Голицино: диагностика, поддержка, помощь при тревоге, стрессе и расстройствах настроения
            </p>
          </header>
          ...
          <div className="mb-8">
            <div className="block md:hidden w-full rounded-[20px] overflow-hidden shadow-md mx-auto">
              <div className="h-[220px] bg-emerald-500 relative overflow-hidden">
                <img src="/images/yslugi/terapiay 1.webp" alt="Психиатр Голицино" className="w-full h-full object-cover" />
              </div>
              <div className="bg-white p-4 flex flex-col gap-3">
                <div className="text-black font-medium text-sm">Психиатр и психолог в Голицино</div>
            ...
            <div className="hidden md:block h-[445px] bg-emerald-500 relative overflow-hidden rounded-[20px] shadow-lg">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-start p-8 md:p-12 text-black">
                <h2 className="text-2xl md:text-4xl font-bold mb-4">Психиатр и психолог в Голицино</h2>
                <p className="text-lg md:text-xl mb-6 max-w-md">Приём врача-психиатра и консультация психолога в Альтамед Голицино</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {["Приём психиатра и психолога в Голицино", "Конфиденциальность и доверительная атмосфера", "Удобная запись и график приёма", "Опытные специалисты — диагностика и поддержка"].map((text, i) => (
      ...
      <section className="py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Психиатр и психолог в Голицино</h2>
          ...
          <p className="text-gray-600">В «Альтамед Голицино» вы можете записаться к психиатру или психологу и пройти консультацию в Голицино.</p>
        </div>
      </section>
      ...
      <section className="py-16" aria-labelledby="services-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 id="services-heading" className="text-3xl font-bold text-gray-900 mb-4">Услуги психиатра и психолога в Голицино</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">Приём врача-психиатра и приём врача-психолога в Альтамед Голицино</p>
          </div>
