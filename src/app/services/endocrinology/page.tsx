        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            <h1 className="text-2xl md:text-3xl font-bold text-black leading-tight px-4 md:px-0">
              Эндокринология в клинике «<span className="italic">Альтамед Голицыно</span>»
            </h1>
            <p className="text-gray-600 mt-2 px-4 md:px-0 text-sm md:text-base">
              Диагностика и лечение заболеваний эндокринной системы в Голицыно
            </p>
          </header>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="bg-blue-50 rounded-[20px] p-8 shadow-lg border-l-4 border-emerald-600">
            ...
            <p className="text-gray-700 leading-relaxed">
              В медицинском центре «Альтамед Голицыно» в Голицыно врачи-эндокринологи диагностируют и лечат заболевания всех желез внутренней секреции, помогая восстановить гормональный баланс и нормализовать работу эндокринной системы. Своевременное обращение к специалисту позволяет предупредить развитие тяжелых осложнений и значительно улучшить состояние здоровья пациента.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="mt-8 bg-blue-50 rounded-[20px] p-8 border-l-4 border-emerald-600">
            <p className="text-gray-700 leading-relaxed mb-4">
              <strong>В медицинском центре «Альтамед Голицыно» в Голицыно</strong> прием эндокринолога длится 30-40 минут, что позволяет специалисту максимально подробно разобраться в проблеме пациента. Врач объясняет результаты обследования, отвечает на все вопросы, дает рекомендации по профилактике и контролю заболевания.
            </p>
            <p className="text-gray-700 leading-relaxed">
              При необходимости назначаются повторные консультации для контроля эффективности лечения и корректировки терапии. Эндокринологи клиники «Альтамед Голицыно» в Голицыно имеют многолетний опыт работы с пациентами всех возрастных категорий и готовы помочь в решении любых проблем, связанных с эндокринной системой.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Консультация хорошего врача-эндокринолога в Голицыно
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Более 60% жителей города сталкиваются с заболеваниями, связанными с нарушениями в работе эндокринной системы. Диабет, ожирение, заболевания щитовидной железы - это те проблемы, которые требуют не паники, а активных действий. В «Альтамед Голицыно» действуют эффективные программы профилактики, диагностики и лечения заболеваний эндокринной системы.
              </p>
              <p className="text-lg text-gray-600 mb-6">
              ...
              <p className="text-lg text-gray-600">
                Записаться к эндокринологу можно в любое удобное время. Специалисты «Альтамед Голицыно» - врачи высшей категории с многолетним опытом работы, готовые решить любую проблему, связанную с заболеваниями желез внутренней секреции. Эндокринологи в Москве доступны в будние и выходные дни, а также в праздничные дни.
              </p>
            </div>
              ...
              {openAccordion === 1 && (
                <div className="px-6 py-4 bg-white">
                  ...
                  <ul className="text-gray-600 space-y-2">
                    ...
                    <li>• МРТ гипофиза и надпочечников</li>
