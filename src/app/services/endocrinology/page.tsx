        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="mt-8 bg-blue-50 rounded-[20px] p-8 border-l-4 border-emerald-600">
            <p className="text-gray-700 leading-relaxed mb-4">
              <strong>В медицинском центре «Альтамед-С» в Голицино</strong> прием эндокринолога длится 30-40 минут, что позволяет специалисту максимально подробно разобраться в проблеме пациента. Врач объясняет результаты обследования, отвечает на все вопросы, дает рекомендации по профилактике и контролю заболевания.
            </p>
            <p className="text-gray-700 leading-relaxed">
              При необходимости назначаются повторные консультации для контроля эффективности лечения и корректировки терапии. Эндокринологи клиники «Альтамед-С» в Голицино имеют многолетний опыт работы с пациентами всех возрастных категорий и готовы помочь в решении любых проблем, связанных с эндокринной системой.
            </p>
          </div>
        </div>
      </section>
