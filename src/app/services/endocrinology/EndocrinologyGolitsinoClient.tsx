...
const whyItems = [
  ...
  "Диагностика щитовидной железы, диабета, ожирения",
  "Приём взрослых и детский эндокринолог",
  "Удобная запись и приём в Голицыно",
];

const symptoms = [
  "усталость, слабость, перепады настроения",
  "набор или потеря веса без причины",
...
const diagnostics = [
  "биоимпедансная спектроскопия (БИС)",
  "лабораторная диагностика гормонов",
  "оценка состава тела",
...
const faqItems = [
  {
    q: "Какими заболеваниями занимается эндокринолог?",
    a: "Эндокринолог диагностирует и лечит заболевания щитовидной железы, сахарный диабет, ожирение, нарушения обмена веществ, гормональные расстройства у взрослых и детей.",
  },
  {
    q: "Принимает ли детский эндокринолог?",
    a: "Да. В «Альтамед Голицыно» ведут приём врач-эндокринолог и детский эндокринолог: первичный, диспансерный и профилактический приём.",
  },
  {
    q: "Как записаться на приём?",
    a: "Запись — через онлайн-регистратуру reg.altamed-golitsino.ru, по телефону +7 (495) 989-64-80 или через форму на этой странице.",
  },
];
...
function Breadcrumbs() {
  return (
    <nav className="flex text-sm text-gray-500" aria-label="Breadcrumb">
      ...
      <span className="mx-2">/</span>
      <span className="text-gray-800">Эндокринолог</span>
    </nav>
  );
}
...
export default function EndocrinologyGolitsinoClient({
  services,
  priceFrom,
}: Props) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-white">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold leading-tight text-gray-900 md:text-4xl">
              Эндокринолог в Голицыно — приём, диагностика и запись в «Альтамед
              Голицыно»
            </h1>
            <p className="mt-4 text-base leading-relaxed text-gray-600 md:text-lg">
              Диагностика и лечение заболеваний эндокринной системы: щитовидная
              железа, диабет, ожирение, гормональные нарушения. Приём взрослого
              и детского эндокринолога.
            </p>
      ...
      <section id="reasons" className="scroll-mt-24 py-12">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="mb-8 text-2xl font-bold text-gray-900 md:text-3xl">
            С чем эндокринолог помогает разобраться
          </h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {helpsWith.map((item) => (
              <div
