  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <section className="pt-4 md:pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h1 className="text-2xl md:text-4xl font-bold text-black">
            Манипуляции общего назначения в Голицино — лечебные блокады и диагностика в медицинском центре Альтамед Голицино
          </h1>
        </div>
      </section>
          ...
          <div className="bg-emerald-500 rounded-[20px] overflow-hidden">
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-1/2 p-6 md:p-8 text-white">
                <p className="mb-4">
                  Манипуляции общего назначения — это лечебные и диагностические процедуры, которые проводятся в медицинском центре Альтамед Голицино: лечебные блокады (перикраниальные, паравертебральные, грушевидной мышцы, фасеточных суставов и др.), интенсивная инфузионная терапия при острых состояниях, суточное мониторирование артериального давления и холтеровское мониторирование ЭКГ, 13С-уреазный дыхательный тест на Helicobacter Pylori, экспресс-диагностика уровня глюкозы и кетонов крови.
                </p>
                <p className="mb-4">
                ...
                <p>
                  Все манипуляции выполняются опытными специалистами с соблюдением стандартов. Записаться на процедуры в Альтамед Голицино можно через форму на сайте или по телефону.
                </p>
              </div>
              <div className="w-full md:w-1/2 relative h-[240px] md:h-auto">
                <Image
                  src="/images/yslugi/fizio.webp"
                  alt="Манипуляции общего назначения в Альтамед Голицино"
                  fill
      ...
      <section className="py-4">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">
            Преимущества манипуляций общего назначения в Альтамед Голицино
          </h2>
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-[20px] p-6">
                ...
                <p className="text-gray-700 mt-4">
                  Назначение на лечебные блокады, инфузию или диагностические манипуляции даёт врач после осмотра. В Альтамед Голицино процедуры проводятся по показаниям и с учётом противопоказаний.
                </p>
              </div>
            </div>
            <div>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">
            Как проводятся манипуляции в Альтамед Голицино
          </h2>
      ...
      <section className="py-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h3 className="text-2xl font-bold mb-4">Подготовка к процедурам в Альтамед Голицино</h3>
          <div className="text-gray-800 space-y-4">
            ...
            <p>
              Экспресс-диагностика глюкозы/кетонов может проводиться натощак или по указанию врача. Все детали уточняйте при записи в клинику Альтамед Голицино.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">
            Виды манипуляций в Альтамед Голицино
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-sm md:text-base text-gray-700 mb-4">
            Стоимость указана за одну процедуру/исследование и носит информационный характер. Актуальные цены уточняйте у администратора клиники Альтамед Голицино.
          </p>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">
            Почему выбирают манипуляции общего назначения в Альтамед Голицино
          </h2>
