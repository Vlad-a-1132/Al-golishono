    ...
    <div className="flex flex-col bg-white">
      <section className="pt-4 md:pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-black">
            Суточное мониторирование артериального давления в Голицино — исследование в медицинском центре Альтамед Голицино
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="w-full md:w-1/2 text-gray-700 space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-black">СМАД в Голицино</h2>
              <p>
              ...
              <p>
                В медицинском центре Альтамед Голицино СМАД проводится на современном оборудовании. Прибор автоматически измеряет давление через заданные интервалы (днём чаще, ночью реже), что позволяет оценить суточный ритм АД, выявить скрытую гипертонию и «гипертонию белого халата», подобрать оптимальное лечение.
              </p>
              <p>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            В медицинском центре Альтамед Голицино расшифровку и заключение выполняет врач функциональной диагностики. Результаты выдаются в течение 1–2 рабочих дней после снятия аппарата. Исследование неинвазивно и безопасно для пациентов любого возраста.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Когда стоит пройти СМАД в Голицино</h2>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Как проходит СМАД в Альтамед Голицино</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Что анализирует врач при расшифровке СМАД в Голицино</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Врач функциональной диагностики медицинского центра Альтамед Голицино при расшифровке суточной записи АД оценивает:
          </p>
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            На основе этих данных формулируется заключение и даются рекомендации по дальнейшему обследованию или коррекции лечения. СМАД в Альтамед Голицино — информативный метод диагностики артериальной гипертонии и подбора терапии.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Преимущества СМАД в Альтамед Голицино</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
