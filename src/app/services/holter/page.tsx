    ...
    <div className="flex flex-col bg-white">
      <section className="pt-4 md:pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-black">
            Холтерское мониторирование электрокардиограммы в Голицыно — исследование в медицинском центре Альтамед Голицыно
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <div className="w-full md:w-1/2">
              <div className="relative w-full aspect-square max-w-md mx-auto rounded-full overflow-hidden">
                <Image
                  ...
                  alt="Холтер в Альтамед Голицыно"
                  fill
            ...
            <div className="w-full md:w-1/2 text-gray-700 space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-black">Холтеровское мониторирование ЭКГ в Голицыно</h2>
              <p>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Разовая ЭКГ в покое фиксирует состояние сердца лишь в момент записи — несколько десятков секунд. Многие аритмии и эпизоды ишемии возникают эпизодически: при нагрузке, стрессе, во сне. Холтер позволяет «поймать» эти эпизоды и связать их с жалобами пациента (если он ведёт дневник активности и отмечает время появления симптомов). В медицинском центре Альтамед Голицыно расшифровку и заключение выполняет врач функциональной диагностики.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Когда стоит пройти Холтер в Голицыно</h2>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Как проходит Холтер в Альтамед Голицыно</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Что анализирует врач при расшифровке Холтера в Голицыно</h2>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Врач функциональной диагностики медицинского центра Альтамед Голицыно при расшифровке суточной записи ЭКГ оценивает:
          </p>
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            На основе этих данных формулируется заключение и даются рекомендации по дальнейшему обследованию или лечению. Холтер в Альтамед Голицыно — информативный метод диагностики скрытых нарушений ритма и ишемии сердца.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Преимущества Холтера в Альтамед Голицыно</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
