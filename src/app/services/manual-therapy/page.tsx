        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="space-y-4 text-gray-700">
            <p className="text-base md:text-lg">
              <strong>1. Диагностика.</strong> Врач медицинского центра Альтамед Голицыно проводит тщательное обследование, выявляет проблемные зоны, оценивает состояние позвоночника и суставов. При необходимости назначаются дополнительные исследования (рентген). Диагностика включает визуальный осмотр, пальпацию и специальные тесты на подвижность.
            </p>
            <p className="text-base md:text-lg">
