...
const traumatologyServices = [
  {
    ...
    services: [
      { name: "Прием (осмотр, консультация) врача-травматолога-ортопеда первичный", price: "4 200 руб." },
      { name: "Прием (осмотр, консультация) врача-травматолога-ортопеда повторный", price: "3 400 руб." },
    ]
  },
  {
    category: "Инъекционная терапия",
    services: [
      { name: "Внутрикостное введение лекарственных препаратов", price: "2 500 руб." },
      { name: "Внутрисуставное введение лекарственных препаратов", price: "2 500 руб." },
      { name: "Пункция синовиальной сумки сустава", price: "4 200 руб." },
      { name: "Околосуставное введение лекарственных препаратов", price: "2 500 руб." },
      { name: "Плазмолифтинг PRP (введение обогащенной тромбоцитами ауто плазмы) пробирка Unique", price: "13 200 руб." },
    ]
  },
  {
    category: "Наложение повязок",
    services: [
      { name: "Наложение повязки при нарушении целостности кожных покровов", price: "1 700 руб." },
      { name: "Наложение повязки при ожогах", price: "1 700 руб." },
      { name: "Наложение повязки при заболеваниях мышц", price: "2 500 руб." },
      { name: "Наложение повязки при переломах костей", price: "2 500 руб." },
      { name: "Наложение иммобилизационной повязки при переломах костей", price: "2 900 руб." },
      { name: "Наложение гипсовой повязки при переломах костей", price: "2 900 руб." },
      { name: "Снятие гипсовой повязки (лонгеты)", price: "1 400 руб." },
      { name: "Снятие циркулярной гипсовой повязки", price: "2 500 руб." },
      { name: "Наложение повязки при вывихах (подвывихах) суставов", price: "2 500 руб." },
    ]
  },
  {
    category: "Хирургические манипуляции",
    services: [
      { name: "Сшивание кожи и подкожной клетчатки", price: "3 100 руб." },
      { name: "Наложение вторичных швов", price: "4 700 руб." },
      { name: "Ушивание открытой раны (без кожной пересадки)", price: "3 100 руб." },
      { name: "Удаление ногтевых пластинок", price: "3 100 руб." },
      { name: "Удаление ногтевой пластинки с клиновидной резекцией матрикса", price: "5 300 руб." },
    ]
  },
  {
    category: "Анестезия",
    services: [
      ...
      { name: "Инфильтрационная анестезия", price: "1 000 руб." },
    ]
  }
];
