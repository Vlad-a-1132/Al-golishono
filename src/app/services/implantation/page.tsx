...
const WORDSTAT_KEYWORDS: string[] = [
  ...
  "имплантация в Голицыно",
  "имплантация зубов в Голицыно",
  "Голицыно имплантация цена",
  "имплантация зубов в Голицыно цены",
  "имплантация зубов Голицыно отзывы",
  "имплантация зубов в Голицыно цены отзывы",
  "стоматология имплантация Голицыно",
  "Голицыно имплантация область",
  "одномоментная имплантация Голицыно"
] ;

export const metadata: Metadata = {
  title: "Имплантация зубов в Голицыно | Клиника «Альтамед Голицыно»",
  description:
    "Проводим имплантацию зубов в Голицыно — клиника «Альтамед Голицыно»: современные импланты, одномоментная установка, прозрачные цены, гарантия результата и комфортное лечение.",
  keywords: WORDSTAT_KEYWORDS,
  alternates: {
    canonical: "https://altamed-golitsino.ru/services/implantation"
  },
  openGraph: {
    title: "Имплантация зубов в Голицыно — стоматология «Альтамед Голицыно»",
    description:
      "Имплантация зубов в Голицыно под ключ: цифровая диагностика, одноэтапная и классическая методика, европейские системы имплантов, гибкие цены и реальные отзывы пациентов.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Имплантация зубов в клинике Альтамед Голицыно в Голицыно"
      }
    ]
  }
};
...
const advantages = [
  ...
  },
  {
    ...
    description:
      "Цифровые оттиски, 3D-моделирование прикуса и хирургические шаблоны повышают точность установки."
  },
  {
...
const stages = [
  {
    ...
    text: "Команда клиники «Альтамед Голицыно» проводит консультацию, диагностику, определяет объём костной ткани и форму улыбки."
  },
  {
    title: "Подготовка и одномоментная установка",
    text: "При достаточном объёме костной ткани выполняется одномоментная имплантация в Голицыно — установка импланта в день удаления зуба."
  },
  {
...
const reviewsSummary = [
  {
    title: "Реальные отзывы из Голицыно",
    text: "Запрос «имплантация зубов Голицыно отзывы» подтверждается историями пациентов: они отмечают безболезненность процедуры, внимательное отношение и понятный план восстановления."
  },
  {
    title: "Стабильные результаты",
    text: "Импланты приживаются без осложнений, а временные коронки устанавливаются в день операции, что соответствует ожиданиям по запросу «имплантация зубов в Голицыно цены отзывы»."
  },
  {
    title: "Комфортная реабилитация",
    text: "После имплантации в Голицыно пациенты отмечают минимальный отёк; врачи на связи 24/7 и дают подробные инструкции по уходу."
  }
] as const;

const faqItems = [
  {
    question: "Сколько стоит имплантация зубов в Голицыно в клинике «Альтамед Голицыно»?",
    answer:
  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Имплантация зубов в клинике «Альтамед Голицыно»
              </h1>
              <p className="text-lg md:text-xl mb-8 text-emerald-100">
                Современные имплантационные системы, одномоментная имплантация и гарантированный результат под контролем опытных стоматологов в Голицыно
              </p>
            </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              <h2 className="text-3xl font-bold text-gray-900">Имплантация в Голицыно: почему выбирают нас</h2>
              <p>
                Клиника «Альтамед Голицыно» предлагает полный комплекс имплантации зубов в Голицыно — от
              ...
              <p>
                Прозрачные цены позволяют планировать бюджет — стоимость имплантации в Голицыно
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Преимущества имплантации в «Альтамед Голицыно»</h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Имплантация зубов в Голицыно: цены и отзывы пациентов
          </h2>
          <div className="space-y-4 text-gray-700 leading-relaxed text-sm md:text-base">
            <p>
              Стоматология «Альтамед Голицыно» — клиника, где имплантация в Голицыно проводится по международным
              протоколам. Мы принимаем пациентов из Голицыно и района, поэтому
              запрос «Голицыно имплантация область» полностью закрывает наши услуги.
            </p>
            <p>
              Прайс ниже отвечает на популярные поисковые запросы Wordstat: «имплантация зубов в Голицыно цены»,
              «имплантация зубов в Голицыно цены отзывы», «Голицыно имплантация цена». Мы регулярно обновляем
              данные, чтобы стоимость имплантации в Голицыно оставалась прозрачной и понятной.
            </p>
            <p>
              Наши пациенты отмечают, что «имплантация зубов Голицыно отзывы» в точности описывают результат:
              аккуратная работа хирургической команды и детальное сопровождение. Если вы ищете стоматологию,
              где «стоматология имплантация Голицыно» — это не просто слоган, а комплексная услуга, записывайтесь
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#4A5568] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                Имплантация в Голицыно включает классические протоколы и одномоментные решения для тех, кому важно восстановить зубы за короткий срок.
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#4A5568] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                Имплантация зубов в Голицыно с учётом прикуса и эстетики гарантирует удобство и естественный результат.
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#4A5568] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                Имплантация зубов в Голицыно цены отзывы — сочетание точной сметы и реального опыта пациентов, которыми мы делимся на консультациях.
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Этапы имплантации зубов в Голицыно
              </h2>
            ...
            <div className="bg-gray-50 rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 text-sm mt-4">
                Перед имплантацией наши врачи-имплантологи в Голицыно проводят расширенное обследование и, при
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Цены на имплантацию зубов в Голицыно</h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Отзывы пациентов об имплантации зубов в Голицыно
          </h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Частые вопросы об имплантации зубов в Голицыно
          </h2>
          <div className="space-y-4">
            {faqItems.map((item) => (
          ...
          <div className="bg-gradient-to-r from-[#4A5568] to-[#5A6474] rounded-[20px] p-8 md:p-12 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Имплантация зубов в Голицыно — начните с бесплатного плана лечения
              </h2>
              <p className="text-white/90 text-sm md:text-base leading-relaxed">
                Запишитесь на консультацию в клинику «Альтамед Голицыно», чтобы узнать стоимость имплантации, подобрать
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "Клиника «Альтамед Голицыно» — имплантация зубов в Голицыно",
                url: "https://altamed-golitsino.ru/services/implantation",
                ...
                areaServed: "Голицыно и район",
                description:
                  "Имплантация зубов в Голицыно: одномоментная и классическая имплантация, современные системы имплантов, 3D-планирование, гарантия и положительные отзывы пациентов.",
                sameAs: [
