...
const WORDSTAT_KEYWORDS: string[] = [
  ...
  "имплантация в голицино",
  "имплантация зубов в голицино",
  "голицино имплантация цена",
  "имплантация зубов в голицино цены",
  "имплантация зубов голицино отзывы",
  "имплантация зубов в голицино цены отзывы",
  "стоматология имплантация голицино",
  "голицино имплантация область",
  "одномоментная имплантация голицино"
] ;

export const metadata: Metadata = {
  title: "Имплантация зубов в Голицино | Клиника «Альтамед Голицино»",
  description:
    "Проводим имплантацию зубов в Голицино — клиника «Альтамед Голицино»: современные импланты, одномоментная установка, прозрачные цены, гарантия результата и комфортное лечение.",
  keywords: WORDSTAT_KEYWORDS,
  alternates: {
    canonical: "https://altamed-golitsino.ru/services/implantation"
  },
  openGraph: {
    title: "Имплантация зубов в Голицино — стоматология «Альтамед Голицино»",
    description:
      "Имплантация зубов в Голицино под ключ: цифровая диагностика, одноэтапная и классическая методика, европейские системы имплантов, гибкие цены и реальные отзывы пациентов.",
    url: "https://altamed-golitsino.ru/services/implantation",
    type: "article",
    images: [
      {
        url: "https://altamed-golitsino.ru/images/yslugi/implant.webp",
        width: 1200,
        height: 630,
        alt: "Имплантация зубов в клинике Альтамед Голицино в Голицино"
      }
    ]
  }
};
...
const stages = [
  {
    ...
    text: "Команда клиники «Альтамед Голицино» проводит консультацию, КТ, определяет объём костной ткани и форму улыбки."
  },
  {
    title: "Подготовка и одномоментная установка",
    text: "При достаточном объёме костной ткани выполняется одномоментная имплантация в Голицино — установка импланта в день удаления зуба."
  },
  {
...
const reviewsSummary = [
  {
    title: "Реальные отзывы из Голицино",
    text: "Запрос «имплантация зубов Голицино отзывы» подтверждается историями пациентов: они отмечают безболезненность процедуры, внимательное отношение и понятный план восстановления."
  },
  {
    title: "Стабильные результаты",
    text: "Импланты приживаются без осложнений, а временные коронки устанавливаются в день операции, что соответствует ожиданиям по запросу «имплантация зубов в Голицино цены отзывы»."
  },
  {
    title: "Комфортная реабилитация",
    text: "После имплантации в Голицино пациенты отмечают минимальный отёк; врачи на связи 24/7 и дают подробные инструкции по уходу."
  }
] as const;

const faqItems = [
  {
    question: "Сколько стоит имплантация зубов в Голицино в клинике «Альтамед Голицино»?",
    answer:
  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Имплантация зубов в клинике «Альтамед Голицино»
              </h1>
              <p className="text-lg md:text-xl mb-8 text-emerald-100">
                Современные имплантационные системы, одномоментная имплантация и гарантированный результат под контролем опытных стоматологов в Голицино
              </p>
            </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              <h2 className="text-3xl font-bold text-gray-900">Имплантация в Голицино: почему выбирают нас</h2>
              <p>
                Клиника «Альтамед Голицино» предлагает полный комплекс имплантации зубов в Голицино — от
              ...
              <p>
                Прозрачные цены позволяют планировать бюджет — стоимость имплантации в Голицино
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Преимущества имплантации в «Альтамед Голицино»</h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Имплантация зубов в Голицино: цены и отзывы пациентов
          </h2>
          <div className="space-y-4 text-gray-700 leading-relaxed text-sm md:text-base">
            <p>
              Стоматология «Альтамед Голицино» — клиника, где имплантация в Голицино проводится по международным
              протоколам. Мы принимаем пациентов из Голицино и района, поэтому
              запрос «голицино имплантация область» полностью закрывает наши услуги.
            </p>
            <p>
              Прайс ниже отвечает на популярные поисковые запросы Wordstat: «имплантация зубов в Голицино цены»,
              «имплантация зубов в Голицино цены отзывы», «Голицино имплантация цена». Мы регулярно обновляем
              данные, чтобы стоимость имплантации в Голицино оставалась прозрачной и понятной.
            </p>
            <p>
              Наши пациенты отмечают, что «имплантация зубов Голицино отзывы» в точности описывают результат:
              аккуратная работа хирургической команды и детальное сопровождение. Если вы ищете стоматологию,
              где «стоматология имплантация Голицино» — это не просто слоган, а комплексная услуга, записывайтесь
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#4A5568] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                Имплантация в Голицино включает классические протоколы и одномоментные решения для тех, кому важно восстановить зубы за короткий срок.
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#4A5568] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                Имплантация зубов в Голицино с учётом прикуса и эстетики гарантирует удобство и естественный результат.
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#4A5568] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                Имплантация зубов в Голицино цены отзывы — сочетание точной сметы и реального опыта пациентов, которыми мы делимся на консультациях.
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Этапы имплантации зубов в Голицино
              </h2>
            ...
            <div className="bg-gray-50 rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 text-sm mt-4">
                Перед имплантацией наши врачи-имплантологи в Голицино проводят расширенное обследование и, при
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Цены на имплантацию зубов в Голицино</h2>
          <p className="text-gray-700 mb-6 leading-relaxed">
            Стоимость имплантации в клинике «Альтамед Голицино» формируется индивидуально, но мы фиксируем цены в
          ...
          <div className="bg-gray-50 rounded-[20px] p-6 shadow-md border border-gray-100">
            ...
            <p className="text-sm text-gray-600 mt-4">
              Для уточнения актуальной цены имплантации зубов в Голицино запишитесь на консультацию — врач
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Отзывы пациентов об имплантации зубов в Голицино
          </h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Частые вопросы об имплантации зубов в Голицино
          </h2>
          <div className="space-y-4">
            {faqItems.map((item) => (
          ...
          <div className="bg-gradient-to-r from-[#4A5568] to-[#5A6474] rounded-[20px] p-8 md:p-12 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Имплантация зубов в Голицино — начните с бесплатного плана лечения
              </h2>
              <p className="text-white/90 text-sm md:text-base leading-relaxed">
                Запишитесь на консультацию в клинику «Альтамед Голицино», чтобы узнать стоимость имплантации, подобрать
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "Клиника «Альтамед Голицино» — имплантация зубов в Голицино",
                url: "https://altamed-golitsino.ru/services/implantation",
                image: "https://altamed-golitsino.ru/images/yslugi/implant.webp",
                ...
                areaServed: "Голицино и район",
                description:
                  "Имплантация зубов в Голицино: одномоментная и классическая имплантация, современные системы имплантов, 3D-планирование, гарантия и положительные отзывы пациентов.",
                sameAs: [
