...
export const metadata = {
  title: 'Запись на прием к врачу онлайн - Медицинский центр Альтамед Голицыно',
  description: 'Запись на прием к врачу онлайн в медицинском центре Альтамед Голицыно. Выберите врача, дату и время, заполните форму записи. Быстро, удобно, без очередей.',
  keywords: [
    'запись на прием Голицыно',
    'запись к врачу онлайн Голицыно',
    'онлайн запись на прием Голицыно',
    'записаться к врачу Голицыно',
    'запись на прием Альтамед Голицыно',
    'электронная запись к врачу Голицыно',
    'запись через интернет Голицыно',
    'Московская область запись к врачу',
    'Голицыно онлайн запись'
  ],
  openGraph: {
    title: 'Запись на прием к врачу онлайн - Медицинский центр Альтамед Голицыно',
    description: 'Запись на прием к врачу онлайн в медицинском центре Альтамед Голицыно. Выберите врача, дату и время, заполните форму записи.',
