...
export const metadata = {
  title: 'Запись на прием к врачу онлайн - Медицинский центр Альтамед Голицино',
  description: 'Запись на прием к врачу онлайн в медицинском центре Альтамед Голицино. Выберите врача, дату и время, заполните форму записи. Быстро, удобно, без очередей.',
  keywords: [
    'запись на прием Голицино',
    'запись к врачу онлайн Голицино',
    'онлайн запись на прием Голицино',
    'записаться к врачу Голицино',
    'запись на прием Альтамед Голицино',
    'электронная запись к врачу Голицино',
    'запись через интернет Голицино',
    'Московская область запись к врачу',
    'Голицино онлайн запись'
  ],
  openGraph: {
    title: 'Запись на прием к врачу онлайн - Медицинский центр Альтамед Голицино',
    description: 'Запись на прием к врачу онлайн в медицинском центре Альтамед Голицино. Выберите врача, дату и время, заполните форму записи.',
