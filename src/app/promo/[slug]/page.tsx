  ...
  const promotions = [
    {
      ...
      fullDescription:
        "Профессиональная гигиена полости рта по фиксированной цене 4600 ₽ — без указания процента. Комплексная чистка, удаление мягкого и твёрдого налёта, полировка эмали под контролем стоматолога в клинике «Альтамед Голицыно».",
      details: [
        "Фиксированная цена: 4600 ₽",
        "Единая стоимость услуги, без указания процента",
    ...
    },
    {
      ...
      fullDescription:
        "Приём педиатра в медицинском центре «Альтамед Голицыно» со скидкой 20%. Запись на консультацию и наблюдение для детей.",
      details: [
        "Скидка 20% на приём педиатра",
        "Акция для детей (педиатр)"
      ]
    },
    {
      id: 10,
      ...
      fullDescription:
        "Лазерная эпиляция в медицинском центре «Альтамед Голицыно»: скидки до 40% на выбранные зоны. Подробности и прайс уточняйте при записи у администратора.",
      details: [
        "Скидки до 40% на выбранные зоны",
        "Лазерная эпиляция на современном оборудовании",
        "Стоимость и зоны — по согласованию при записи"
      ]
    },
    {
      id: 11,
      ...
      fullDescription:
        "Курс из 10 капельниц в медицинском центре «Альтамед Голицыно» со скидкой 20%. Обязательно направление от врача и лекарственные препараты для процедуры: они оплачиваются отдельно или входят в стоимость курса — как именно в вашем случае, уточняйте при записи.",
      details: [
        "Скидка 20% на курс из 10 капельниц",
        "Обязательно: направление от врача",
        "Лекарственные препараты для капельниц: оплата отдельно или в составе курса — условие уточняется при записи"
      ]
    },
    {
      id: 2,
