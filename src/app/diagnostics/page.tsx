  ...
  const faqItems = [
    {
      ...
      answer: "Клиника «Альтамед Голицыно» предоставляет широкий спектр диагностических услуг: лучевая диагностика (рентген, УЗИ, МРТ), эндоскопические исследования (гастроскопия, колоноскопия, бронхоскопия), функциональная диагностика (ЭКГ, спирометрия, мониторирование), лабораторные анализы всех видов. Все исследования проводятся на современном оборудовании экспертного класса квалифицированными специалистами."
    },
    {
      question: "Нужна ли подготовка перед диагностическими процедурами?",
      answer: "Подготовка зависит от вида исследования. Для большинства УЗИ и рентгена специальная подготовка не требуется. Для гастроскопии необходимо голодание 8-12 часов. Для колоноскопии требуется очищение кишечника специальными препаратами. Для лабораторных анализов часто нужно прийти натощак. Детальную инструкцию по подготовке вы получите при записи на исследование."
    },
    {
    ...
    },
    {
      ...
      answer: "Да, в клинике «Альтамед Голицыно» вы можете пройти большинство диагностических исследований без направления врача в рамках профилактических программ или для уточнения диагноза. Однако для некоторых сложных исследований и процедур может потребоваться консультация врача и направление. Все ограничения вам сообщат при записи на исследование. Специалисты Альтамед Голицыно всегда готовы проконсультировать по выбору необходимых исследований."
    },
    {
      question: "Насколько безопасна диагностика для здоровья?",
      answer: "Все диагностические процедуры в клинике «Альтамед Голицыно» проводятся на современном оборудовании, соответствующем международным стандартам безопасности. Лучевая нагрузка при рентгенографии минимизируется благодаря современным цифровым аппаратам. УЗИ и МРТ не несут лучевой нагрузки. Перед исследованиями с контрастированием проводится оценка противопоказаний и аллергопробы. Все процедуры максимально безопасны для пациентов. Врачи Альтамед Голицыно всегда учитывают индивидуальные особенности пациента при выборе методов диагностики."
    },
    {
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed text-base md:text-lg">
              Клиника «Альтамед Голицыно» предоставляет все виды диагностики: лучевые методы (рентген, УЗИ, МРТ), эндоскопические исследования (гастроскопия, колоноскопия, бронхоскопия), функциональная диагностика (ЭКГ, спирометрия, мониторирование), лабораторные анализы различных видов. Все исследования проводятся квалифицированными врачами-диагностами с многолетним опытом работы. В Альтамед Голицыно используется только современное оборудование от ведущих мировых производителей.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed text-base md:text-lg">
