  ...
  const faqItems = [
    {
      ...
      answer: "Клиника «Альтамед Голицыно» предоставляет широкий спектр диагностических услуг: лучевая диагностика (рентген, УЗИ), эндоскопические исследования (гастроскопия, колоноскопия, бронхоскопия), функциональная диагностика (ЭКГ, спирометрия, мониторирование), лабораторные анализы всех видов. Все исследования проводятся на современном оборудовании экспертного класса квалифицированными специалистами."
    },
    {
    ...
    },
    {
      ...
      answer: "Все диагностические процедуры в клинике «Альтамед Голицыно» проводятся на современном оборудовании, соответствующем международным стандартам безопасности. Лучевая нагрузка при рентгенографии минимизируется благодаря современным цифровым аппаратам. УЗИ не несет лучевой нагрузки. Перед исследованиями с контрастированием проводится оценка противопоказаний и аллергопробы. Все процедуры максимально безопасны для пациентов. Врачи Альтамед Голицыно всегда учитывают индивидуальные особенности пациента при выборе методов диагностики."
    },
    {
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed text-base md:text-lg">
              Клиника «Альтамед Голицыно» предоставляет все виды диагностики: лучевые методы (рентген, УЗИ), эндоскопические исследования (гастроскопия, колоноскопия, бронхоскопия), функциональная диагностика (ЭКГ, спирометрия, мониторирование), лабораторные анализы различных видов. Все исследования проводятся квалифицированными врачами-диагностами с многолетним опытом работы. В Альтамед Голицыно используется только современное оборудование от ведущих мировых производителей.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed text-base md:text-lg">
