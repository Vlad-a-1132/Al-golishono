...
function DoctorPageClient({ data }: { data: PageDataBundle }) {
  ...
  const orthoSeo = data.directionPageBasePath === "/services/dentistry/orthodontics"
    ? getOrthodonticsSeoContent(activeDirection.id)
    : null;
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <SectionShell>
              <ReviewsStrip
                ...
                reviewsSources={data.reviewsSources}
              />
            </SectionShell>
          </div>
        </div>
