...
export const doctors = [
  ...
  { id: 3, name: "Емельянова Анна Игоревна", slug: "emelyanova-anna-igorevna", specialization: "Дерматовенеролог, Дерматолог лечение", experience: 12, photo: "/images/doctors/Emelyanova Anna Igorevna.webp", description: "Врач-дерматовенеролог. Сертифицированный специалист по косметологии и эстетической медицине" },
  ...
  { id: 7, name: "Дмитриев Алексей Олегович", slug: "dmitriev-alexey-olegovich", specialization: "Невролог, Мануальный терапевт, Рефлексотерапевт", experience: 21, photo: "/images/doctors/Dmitriev Alexey Olegovich.webp", description: "Врач невролог, мануальный терапевт, рефлексотерапевт. Стаж работы с 2003г." },
  ...
  { id: 9, name: "Прикуле Елена Юрьевна", slug: "prikule-elena-yuryevna", specialization: "Стоматолог-терапевт", experience: 52, photo: "/images/doctors/Prikule Elena Yuryevna.webp", description: "Врач стоматолог-терапевт" },
  { id: 10, name: "Иванникова Любовь Андреевна", slug: "ivannikova-lyubov-andreevna", specialization: "Стоматолог-терапевт, Стоматология", experience: 10, photo: "/images/doctors/Ivannikova Lyubov Andreevna.webp", description: "Стоматолог-терапевт. Стаж с 2014 года" },
  ...
  { id: 15, name: "Громов Евгений Викторович", slug: "gromov-evgeny-viktorovich", specialization: "Уролог-андролог", experience: 22, photo: "/images/doctors/Gromov Evgeny Viktorovich.webp", description: "Врач-уролог. Стаж работы: с 2002 года" },
  ...
  { id: 24, name: "Рубцова Ольга Юрьевна", slug: "rubtsova-olga-yurievna", specialization: "Стоматолог-хирург, Стоматолог-терапевт, Стоматология", experience: 23, photo: "/images/doctors/Rubtsova Olga Yurievna.webp", description: "Стоматолог-хирург, стоматолог-терапевт. Стаж работы: с 2001 года. В 2011 году награждена орденом «Лучший стоматолог»" },
  ...
  { id: 27, name: "Ярулова Вероника Юрьевна", slug: "yarulova-veronika-yuryevna", specialization: "Стоматолог-терапевт, Стоматология", experience: 22, photo: "/images/doctors/Yarulova Veronika Yuryevna.webp", description: "Стоматолог-терапевт. Стаж работы с 2002 года. С января 2009 года по сегодняшний день врач-стоматолог терапевт в «Альтамед-С»" },
  ...
  { id: 33, name: "Гончаренко Елена Борисовна", slug: "goncharenko-elena-borisovna", specialization: "Ортодонт, Стоматология", experience: 27, photo: "/images/doctors/Goncharenko Elena Borisovna.webp", description: "Врач-ортодонт высшей квалификационной категории. Стаж работы: с 1997 года" },
  ...
  { id: 50, name: "Абрамов Юно Эриильевич", slug: "abramov-yuno-eriilevich", specialization: "Стоматолог-хирург, Стоматология", experience: 6, photo: "/images/doctors/Abramov Yuno Eriilevich.webp", description: "Врач стоматолог-хирург. Окончил Первый московский государственный медицинский университет им. И.М.Сеченова" },
